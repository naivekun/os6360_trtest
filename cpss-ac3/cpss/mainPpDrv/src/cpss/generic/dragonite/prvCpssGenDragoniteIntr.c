...
/**
* @internal dragoniteInterruptsHwReadRegister function
* @endinternal
*
* @brief   Function performing hardware read of Dragonite interrupt cause register.
*         Just this one register interesting to read for Dragonite interrupt
*         management
*
* @note   APPLICABLE DEVICES:      xCat; xCat3.
* @note   NOT APPLICABLE DEVICES:  DxCh1; DxCh1_Diamond; DxCh2; DxCh3; Lion; xCat2; ExMxPm; ExMx.
*
* @param[in] devNum                   - The device number to read. - not relevant for DRAGONITE
* @param[in] portGroupId              - The port group Id. support the 'multi-port-groups' device.
...
* @param[in] regAddr                  - The register's address to read from - ignored, because actually used to read just cause register
*                                      for DRAGONITE - not relevant
*
* @param[out] dataPtr                  - Data word pointer for read data.
*                                       GT_OK on success,
*                                       GT_FAIL otherwise.
*/
static GT_STATUS dragoniteInterruptsHwReadRegister
...
/**
* @internal dragoniteInterruptsHwWriteRegister function
* @endinternal
*
* @brief   Function performing hardware write of Dragonite interrupt cause or
*         mask registers
*
* @note   APPLICABLE DEVICES:      xCat; xCat3.
* @note   NOT APPLICABLE DEVICES:  DxCh1; DxCh1_Diamond; DxCh2; DxCh3; Lion; xCat2; ExMxPm; ExMx.
*
* @param[in] devNum                   - The device number to write - ignored for DRAGONITE
* @param[in] portGroupId              - The port group Id. support the 'multi-port-groups' device.
*                                      for PP - for non 'multi-port-group' devices use PRV_CPSS_DRV_NON_MULTI_PORT_GROUP_DEVICE_INDEX_CNS
*                                      for FA,Xbar,DRAGONITE - not relevant
* @param[in] regAddr                  - The register's address to write to - may be or cause or mask register
...
/**
* @internal dragoniteDrvReqDrvnMaskSet function
* @endinternal
*
...
*                                       GT_FAIL otherwise.
*
* @note Used in Event Request Driven mode (polling).
*
*/
...
/**
* @internal interruptDragoniteSR function
* @endinternal
*
* @brief   This is the DRAGONITE controller interrupt service routine, it scans the
*         interrupts and enqueues each of them to the interrupt queues structure.
*
* @note   APPLICABLE DEVICES:      xCat; xCat3.
* @note   NOT APPLICABLE DEVICES:  DxCh1; DxCh1_Diamond; DxCh2; DxCh3; Lion; xCat2; ExMxPm; ExMx.
*
* @param[in] cookiePtr                - pointer to cookie.
*
...
/**
* @internal dragoniteIntCauseToUniEvConvert function
* @endinternal
*
...
* @note   NOT APPLICABLE DEVICES:  DxCh1; DxCh1_Diamond; DxCh2; DxCh3; Lion; xCat2; ExMxPm; ExMx.
*
* @param[in] intCause                 - The interrupt cause to convert.
*
* @param[out] uniEvPtr                 - The unified event type.
* @param[out] extDataPtr               - The event extended data.
*                                       GT_OK on success, or
*                                       GT_NOT_FOUND otherwise.
*
* @note Usually return status of this function not checked
*
*/
...
/**
* @internal dragoniteInterruptsRegsInit function
* @endinternal
*
* @brief   Initialize IRQ related registers in DTCM
*
* @note   APPLICABLE DEVICES:      xCat; xCat3.
* @note   NOT APPLICABLE DEVICES:  DxCh1; DxCh1_Diamond; DxCh2; DxCh3; Lion; xCat2; ExMxPm; ExMx.
*
...
* @endinternal
*
* @brief   This routine mask/unmasks an unified event on Dragonite
*
* @note   APPLICABLE DEVICES:      xCat; xCat3.
* @note   NOT APPLICABLE DEVICES:  DxCh1; DxCh1_Diamond; DxCh2; DxCh3; Lion; xCat2; ExMxPm; ExMx.
*
* @param[in] devNum                   - not in use
...
{
    return prvCpssDrvEvReqUniEvMaskSet(devNum, dragoniteInterruptsCtrlStruct.intNodesPool,
...
* @endinternal
*
* @brief   This routine gets dats if an unified event on Dragonite masked or unmasked
*
* @note   APPLICABLE DEVICES:      xCat; xCat3.
* @note   NOT APPLICABLE DEVICES:  DxCh1; DxCh1_Diamond; DxCh2; DxCh3; Lion; xCat2; ExMxPm; ExMx.
*
...
{
    return prvCpssDrvEvReqUniEvMaskGet(devNum, dragoniteInterruptsCtrlStruct.intNodesPool,
                                        PRV_CPSS_GEN_DRAGONITE_IRQ_MAX_E+1,
...
*
* @note   APPLICABLE DEVICES:      xCat; xCat3.
* @note   NOT APPLICABLE DEVICES:  DxCh1; DxCh1_Diamond; DxCh2; DxCh3; Lion; xCat2; Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; Puma2; Puma3; ExMx.
*
...
)
{
    ...
    retVal = prvCpssGenEventMaskGetDeviceBind(PRV_CPSS_DEVICE_TYPE_DRAGONITE_E,&drvEventMaskGetDevice);
    if(retVal != GT_OK)
    {
        return retVal;
    }

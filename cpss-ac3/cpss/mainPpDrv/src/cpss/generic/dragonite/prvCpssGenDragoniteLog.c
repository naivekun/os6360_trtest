...
)
{
    ...
    PRV_CPSS_LOG_UNUSED_MAC(inOutParamInfoPtr);
    PRV_CPSS_LOG_STC_32_HEX_MAC(valPtr, systemMask0);
...
PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_GEN_DRAGONITE_DATA_STC_PTR_dataPtr = {
     "dataPtr", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(CPSS_GEN_DRAGONITE_DATA_STC)
};
PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_GEN_DRAGONITE_DATA_TYPE_ENT_type = {
     "type", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_MAC(CPSS_GEN_DRAGONITE_DATA_TYPE_ENT)
};
PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_U32_HEX_intMask = {
     "intMask", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_MAC(GT_U32_HEX)
};
PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_U32_intVectNum = {
     "intVectNum", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_MAC(GT_U32)
};
PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_CPSS_GEN_DRAGONITE_DATA_STC_PTR_dataPtr = {
...
PRV_CPSS_LOG_FUNC_PARAM_STC * cpssDragoniteWrite_PARAMS[] =  {
    &DX_IN_CPSS_GEN_DRAGONITE_DATA_STC_PTR_dataPtr
};
PRV_CPSS_LOG_FUNC_PARAM_STC * cpssDragoniteReadTrigger_PARAMS[] =  {
    &DX_IN_CPSS_GEN_DRAGONITE_DATA_TYPE_ENT_type
};
PRV_CPSS_LOG_FUNC_PARAM_STC * cpssDragoniteInit_PARAMS[] =  {
    &DX_IN_GT_U32_intVectNum,
    &DX_IN_GT_U32_HEX_intMask
};
PRV_CPSS_LOG_FUNC_PARAM_STC * cpssDragoniteReadData_PARAMS[] =  {
    &DX_OUT_CPSS_GEN_DRAGONITE_DATA_STC_PTR_dataPtr
};
...
/******** DB Access Function ********/
void prvCpssLogParamLibDbGet_DX_CPSS_LOG_LIB_DRAGONITE(

...
PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_U32_ARRAY_quantumArrPtr = {
     "quantumArrPtr", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_ARRAY_MAC(GT_U32)
};
PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_BOOL_ARRAY_priosPtr = {
     "priosPtr", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_ARRAY_MAC(GT_BOOL)
};
PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_U32_ARRAY_probabilityArr = {

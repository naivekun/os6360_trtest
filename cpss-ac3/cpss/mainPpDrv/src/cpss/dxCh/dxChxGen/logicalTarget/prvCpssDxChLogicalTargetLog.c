...
PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_LOGICAL_TARGET_MAPPING_EGRESS_VLAN_MEMBER_ACCESS_MODE_ENT_mode = {
...
PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_LOGICAL_TARGET_MAPPING_STC_PTR_logicalPortMappingTablePtr = {
     "logicalPortMappingTablePtr", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(CPSS_DXCH_LOGICAL_TARGET_MAPPING_STC)
};
PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_U32_vlanIdIndex = {
     "vlanIdIndex", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_MAC(GT_U32)
};
PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_U8_logicalDevNum = {
     "logicalDevNum", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_MAC(GT_U8)
};
PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_U8_logicalPortNum = {
     "logicalPortNum", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_MAC(GT_U8)
};
PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_CPSS_DXCH_LOGICAL_TARGET_MAPPING_EGRESS_VLAN_MEMBER_ACCESS_MODE_ENT_PTR_modePtr = {
...
PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_CPSS_DXCH_LOGICAL_TARGET_MAPPING_STC_PTR_logicalPortMappingTablePtr = {
     "logicalPortMappingTablePtr", PRV_CPSS_LOG_PARAM_OUT_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(CPSS_DXCH_LOGICAL_TARGET_MAPPING_STC)
};
PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_GT_U32_PTR_vlanIdIndexPtr = {

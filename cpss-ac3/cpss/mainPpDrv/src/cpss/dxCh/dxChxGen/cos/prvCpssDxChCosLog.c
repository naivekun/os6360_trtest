...
PRV_CPSS_LOG_FUNC_PARAM_STC * cpssDxChCosRemarkTblEntryGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_U32_profileIndex,
    &DX_OUT_GT_U32_PTR_newProfileIndexPtr
};

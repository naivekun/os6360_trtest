...
* @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device
*
* @note pay attention that the router ARP table is shared with a tunnel start
...
*
* @param[in] devNum                   - the device number
* @param[in] routerArpIndex           - The Arp Address index (to be inserted later in the
...
* @retval GT_OK                    - on success
* @retval GT_BAD_PARAM             - on devNum not active.
* @retval GT_OUT_OF_RANGE          - on routerArpIndex bigger then 4095 or
* @retval GT_BAD_PTR               - one of the parameters is NULL pointer
* @retval GT_NOT_SUPPORTED         - request is not supported for this device type.
* @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device
*
...
* @note   NOT APPLICABLE DEVICES:  xCat3; Lion2; Bobcat2; Caelum; Aldrin; xCat3x; Bobcat3; Aldrin2; Falcon.
*
* @param[in] devNum                   -  the device number
*
...
)
{
    ...
    if ((PRV_CPSS_SIP_6_CHECK_MAC(devNum) && PRV_CPSS_PP_MAC(devNum)->devFamily != CPSS_PP_FAMILY_DXCH_FALCON_E) ||
        (PRV_CPSS_PP_MAC(devNum)->devFamily == CPSS_PP_FAMILY_DXCH_FALCON_E &&
         prvCpssDxchFalconCiderVersionGet() >= PRV_CPSS_DXCH_FALCON_CIDER_VERSION_18_06_06_E/*former18_04_22*/))
    {
...
/**
* @internal prvCpssDxChTableIpvxRouterEcmpNumEntriesGet function
* @endinternal
*
* @brief   Function to get the number of ECMP table 'logical' entries
*
* @note   APPLICABLE DEVICES:      Aldrin2; Falcon
* @note   NOT APPLICABLE DEVICES:  xCat3; Lion2; Bobcat2; Caelum; Aldrin; xCat3x; Bobcat3; Aldrin2; Falcon.
*
* @param[in] devNum                   -  the device number
*
* @retval The number of ECMP table 'logical' entries.
*
* @note none.
*
*/
GT_U32  prvCpssDxChTableIpvxRouterEcmpNumEntriesGet(
    IN  GT_U8                       devNum
)
{
    GT_U32  numLines;
    ...
    numLines = PRV_TABLE_INFO_PTR_GET_MAC(devNum,tableType)->maxNumOfEntries;
...
* @param[in] devNum                   -  the device number
* @param[in] indirectIndex            - index of ECMP/QOS indirect table
* @param[in] nextHopIndexPtr          - Pointer the the next hope index at Next Hope Table
*
* @retval GT_OK                    - on success.
* @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device.
* @retval GT_OUT_OF_RANGE          - on out of range parameter.
...
)
{
    ...
    PRV_CPSS_DXCH_DEV_CHECK_MAC(devNum);
    PRV_CPSS_NOT_APPLICABLE_DEV_CHECK_MAC(devNum, CPSS_XCAT3_E | CPSS_XCAT2_E | CPSS_LION_E | CPSS_LION2_E |
          CPSS_BOBCAT2_E | CPSS_CAELUM_E | CPSS_ALDRIN_E | CPSS_AC3X_E | CPSS_BOBCAT3_E);
...
* @param[in] devNum                   -  the device number
* @param[in] indirectIndex            - index of ECMP/QOS indirect table
*                                      nextHopIndex        - address of the next hope at Next Hope Table
*
* @retval GT_OK                    - on success.
* @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device.
* @retval GT_OUT_OF_RANGE          - on out of range parameter.

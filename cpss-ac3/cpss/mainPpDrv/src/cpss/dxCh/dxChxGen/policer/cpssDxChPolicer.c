...
/**
* @internal cpssDxChPolicerRateCalcSw function
* @endinternal
*
* @brief   This routine calculate the : (SW)user rate , (SW)user cbs from
*         rateType , actual rate , actual cbs in Hw
*
* @note   APPLICABLE DEVICES:      DxCh1; DxCh1_Diamond; DxCh2; DxCh3; xCat; xCat3; Lion; xCat2.
* @note   NOT APPLICABLE DEVICES:  None.
*
* @param[in] hwRate                   -the rate type field read from Hw
*                                      (bits 26..28 word 0 - tc entry)
* @param[in] hwRate                   - the rate field read from Hw
*                                      (bits 16..25 word 0 - tc entry)
* @param[in] hwlCbs                   -  the cbs field read from Hw
*                                      (bits 0..15 word 0 - tc entry)
*
* @param[out] userRatePtr              - (pointer to)the rate that the user asked for (Kbps)
* @param[out] userCbsPtr               - (pointer to)the cbs that the user asked for (Bytes)
*
...
/**
* @internal cpssDxChPolicerRateCalcHw function
* @endinternal
*
* @brief   This routine calculate the : rateType , actual rate , actual cbs
*         that result from user rate , user cbs
*
* @note   APPLICABLE DEVICES:      DxCh1; DxCh1_Diamond; DxCh2; DxCh3; xCat; xCat3; Lion; xCat2.
* @note   NOT APPLICABLE DEVICES:  None.
*
* @param[in] userRate                 - the rate that the user asked for (Kbps)
* @param[in] userCbs                  - the cbs that the user asked for (Bytes)
*
* @param[out] rateTypePtr              - (pointer to) the rate type field to write to Hw
*                                      (bits 26..28 word 0 - tc entry)
* @param[out] actualRatePtr            - (pointer to) the rate field to write to Hw
*                                      (bits 16..25 word 0 - tc entry)
* @param[out] actualCbsPtr             - (pointer to) the cbs field to write to Hw
*                                      (bits 0..15 word 0 - tc entry)
*
* @retval GT_OK                    - on success
* @retval GT_FAIL                  - on error
...
/**
* @internal internal_cpssDxChPolicerPacketSizeModeSet function
* @endinternal
*
...
/**
* @internal internal_cpssDxChPolicerDropRedModeSet function
* @endinternal
*
...
/**
* @internal internal_cpssDxChPolicerPacketSizeModeForTunnelTermSet function
* @endinternal
*
...
/**
* @internal internal_cpssDxChPolicerTokenBucketModeSet function
* @endinternal
*
...
/**
* @internal internal_cpssDxChPolicerEntrySet function
* @endinternal
*
...
/**
* @internal internal_cpssDxChPolicerEntryGet function
* @endinternal
*
...
/**
* @internal internal_cpssDxChPolicerEntryInvalidate function
* @endinternal
*
...
/**
* @internal internal_cpssDxChPolicerEntryMeterParamsCalculate function
* @endinternal
*
...
/**
* @internal internal_cpssDxChPolicerCountersGet function
* @endinternal
*
...
/**
* @internal internal_cpssDxChPolicerCountersSet function
* @endinternal
*

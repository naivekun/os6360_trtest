...
PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_CPSS_DXCH_TCAM_MANAGER_ENTRY_AMOUNT_STC_PTR_2_allocatedEntriesArray = {
     "allocatedEntriesArray", PRV_CPSS_LOG_PARAM_OUT_E, prvCpssLogParamFunc_CPSS_DXCH_TCAM_MANAGER_ENTRY_AMOUNT_STC_PTR_sizeSet
};
PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_CHAR_ARRAY_clientNameArr = {

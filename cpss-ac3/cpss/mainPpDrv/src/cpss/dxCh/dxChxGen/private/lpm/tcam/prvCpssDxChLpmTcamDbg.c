...
/**
* @internal IpLttRead function
* @endinternal
*
* @brief   This func reads LTT data .
*
...
* @param[in] lttTtiRow                - router tti TCAM row
* @param[in] lttTtiColumn             - router tti TCAM column
*
* @param[out] dataPtr                  - pointer to LTT data
*
* @retval GT_OK                    - on success.
...
/**
* @internal readIpv4Prefix function
* @endinternal
*
* @brief   This func reads ipv4 prefixes from physical router tcam .
*
...
*
* @param[in] devNum                   - the device number
* @param[in] row                      - router tti TCAM row
* @param[in] column                   - router tti TCAM column
*
* @param[out] word0Ptr                 - pointer to first word of TCAM key (hw format) per specific column
* @param[out] word1Ptr                 - pointer to second word  of TCAM key (hw format) per specific column
* @param[out] mask0Ptr                 - pointer to first word of TCAM mask (hw format)
* @param[out] mask1Ptr                 - pointer to second  word of TCAM mask (hw format)
*
* @retval GT_OK                    - on success.
* @retval GT_BAD_PARAM             - on bad parameter.
* @retval GT_BAD_PTR               - on NULL pointer
...
* @retval GT_HW_ERROR              - on hardware error
* @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device
* @retval GT_FAIL                  - if pp family nor CHEETAH2 and nor CHEETAH3.
*
* @note none
*
*/

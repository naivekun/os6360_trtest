...
)
{
    ...
    {
        smiInstance  = PRV_CPSS_PP_MAC(devNum)->phyPortInfoArray[portMacNum].smiIfInfo.smiInterface;
        if (smiInstance == PRV_CPSS_PHY_INVALID_SMI_INSTANCE_CNS)
        {
            /* Aldrin have two SMI interfaces this function divides interfaces between MACs as following */
            smiInstance = (portMacNum < 16)? 0:1;
        }
        ...
        {
            smiLocalPort = portMacNum - 16; /*minus num of port per SMI */
        }
...
*         on specified device.
*
* @note   APPLICABLE DEVICES:      DxCh1; DxCh1_Diamond; DxCh2; DxCh3; xCat; xCat3; Lion; xCat2; Lion2; Bobcat2; Caelum; Bobcat3; Aldrin2; Falcon; Aldrin; AC3X.
* @note   NOT APPLICABLE DEVICES:  None.
*
* @param[in] devNum                   - physical device number
* @param[in] portNum                  - physical port number
...
*
* @note   APPLICABLE DEVICES:      DxCh1; DxCh1_Diamond; DxCh2; DxCh3; xCat; xCat3; Lion; xCat2; Lion2; Bobcat2; Caelum; Bobcat3; Aldrin2; Falcon.
...
* @param[in] devNum                   - physical device number.
* @param[in] portNum                  - port number
* @param[in] enable                   - 0 = Auto-Negotiation process is preformed.
*                                      1 = Auto-Negotiation process is not preforme
*
* @retval GT_OK                    - on success
* @retval GT_BAD_PARAM             - on wrong devNum or portNum.
...
* @note   NOT APPLICABLE DEVICES:  DxCh1; DxCh1_Diamond; DxCh2; DxCh3; xCat; Lion; xCat2; Lion2; Aldrin; AC3X.
*
* @param[in] devNum                   - physical device number.
* @param[in] portNum                  - port number.
*
...
)
{
    ...
    PRV_CPSS_NOT_APPLICABLE_DEV_CHECK_MAC(devNum, CPSS_CH1_E
                   | CPSS_CH1_DIAMOND_E | CPSS_CH2_E | CPSS_CH3_E | CPSS_LION_E
                   | CPSS_XCAT_E | CPSS_XCAT2_E | CPSS_ALDRIN_E | CPSS_AC3X_E | CPSS_LION2_E);

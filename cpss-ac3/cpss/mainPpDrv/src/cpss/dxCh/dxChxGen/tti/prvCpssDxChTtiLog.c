...
PRV_CPSS_ENUM_STRING_VALUE_PAIR_STC prvCpssLogEnum_map_CPSS_DXCH_TTI_ACTION_TYPE_ENT[]  =
{PRV_CPSS_LOG_ENUM_NAME_AND_VALUE_MAC(CPSS_DXCH_TTI_ACTION_TYPE2_ENT)
};
PRV_CPSS_LOG_STC_ENUM_MAP_ARRAY_SIZE_MAC(CPSS_DXCH_TTI_ACTION_TYPE_ENT);
...
char * prvCpssLogEnum_CPSS_DXCH_TTI_FCOE_EXCEPTION_ENT[]  =
{
...
)
{
    ...
    PRV_CPSS_LOG_STC_BOOL_MAC(valPtr, tunnelHeaderStartL4Enable);
...
)
{
    ...
    PRV_CPSS_LOG_ENUM_MAP_MAC(namePtr, paramVal, CPSS_DXCH_TTI_ACTION_TYPE_ENT);
}
...
PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_TTI_ACTION_TYPE_ENT_actionType = {
     "actionType", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_MAC(CPSS_DXCH_TTI_ACTION_TYPE_ENT)
};
PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_TTI_ACTION_UNT_PTR_actionPtr = {
     "actionPtr", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(CPSS_DXCH_TTI_ACTION_UNT)
};
PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_TTI_EXCEPTION_ENT_exceptionType = {
     "exceptionType", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_MAC(CPSS_DXCH_TTI_EXCEPTION_ENT)
};
PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_TTI_FCOE_EXCEPTION_ENT_exceptionType = {
     "exceptionType", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_MAC(CPSS_DXCH_TTI_FCOE_EXCEPTION_ENT)
};
PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_TTI_KEY_SIZE_ENT_size = {
     "size", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_MAC(CPSS_DXCH_TTI_KEY_SIZE_ENT)
};
PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_TTI_KEY_TCAM_SEGMENT_MODE_ENT_segmentMode = {
     "segmentMode", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_MAC(CPSS_DXCH_TTI_KEY_TCAM_SEGMENT_MODE_ENT)
};
PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_TTI_MAC_MODE_ENT_macMode = {
     "macMode", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_MAC(CPSS_DXCH_TTI_MAC_MODE_ENT)
};
PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_TTI_MAC_TO_ME_SRC_INTERFACE_INFO_STC_PTR_interfaceInfoPtr = {
     "interfaceInfoPtr", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(CPSS_DXCH_TTI_MAC_TO_ME_SRC_INTERFACE_INFO_STC)
};
PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_TTI_MAC_VLAN_STC_PTR_maskPtr = {
     "maskPtr", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(CPSS_DXCH_TTI_MAC_VLAN_STC)
};
PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_TTI_MAC_VLAN_STC_PTR_valuePtr = {
     "valuePtr", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(CPSS_DXCH_TTI_MAC_VLAN_STC)
};
PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_TTI_MULTICAST_DUPLICATION_MODE_ENT_mode = {
     "mode", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_MAC(CPSS_DXCH_TTI_MULTICAST_DUPLICATION_MODE_ENT)
};
PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_TTI_OFFSET_TYPE_ENT_offsetType = {
     "offsetType", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_MAC(CPSS_DXCH_TTI_OFFSET_TYPE_ENT)
};
PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_TTI_PW_CW_EXCEPTION_ENT_exceptionType = {
     "exceptionType", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_MAC(CPSS_DXCH_TTI_PW_CW_EXCEPTION_ENT)
};
PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_TTI_RULE_TYPE_ENT_ruleType = {
     "ruleType", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_MAC(CPSS_DXCH_TTI_RULE_TYPE_ENT)
};
PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_TTI_RULE_UNT_PTR_maskPtr = {
     "maskPtr", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(CPSS_DXCH_TTI_RULE_UNT)
};
PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_TTI_RULE_UNT_PTR_patternPtr = {
     "patternPtr", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(CPSS_DXCH_TTI_RULE_UNT)
};
PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_TTI_TRILL_ADJACENCY_STC_PTR_ttiTrillAdjacencyPtr = {
     "ttiTrillAdjacencyPtr", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(CPSS_DXCH_TTI_TRILL_ADJACENCY_STC)
};
PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_ETHER_MODE_ENT_mode = {
     "mode", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_MAC(CPSS_ETHER_MODE_ENT)
};
PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_IP_PROTOCOL_STACK_ENT_ipType = {
     "ipType", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_MAC(CPSS_IP_PROTOCOL_STACK_ENT)
};
PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_NET_RX_CPU_CODE_ENT_PTR_cpuCodePtr = {
     "cpuCodePtr", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(CPSS_NET_RX_CPU_CODE_ENT)
};
PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_NET_RX_CPU_CODE_ENT_code = {
     "code", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_MAC(CPSS_NET_RX_CPU_CODE_ENT)
};
PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_PACKET_CMD_ENT_PTR_commandPtr = {
     "commandPtr", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(CPSS_PACKET_CMD_ENT)
};
PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_TUNNEL_ETHERTYPE_TYPE_ENT_ethertypeType = {
     "ethertypeType", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_MAC(CPSS_TUNNEL_ETHERTYPE_TYPE_ENT)
};
PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_TUNNEL_MULTICAST_TYPE_ENT_protocol = {
     "protocol", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_MAC(CPSS_TUNNEL_MULTICAST_TYPE_ENT)
};
PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_ETHERADDR_PTR_addressPtr = {
     "addressPtr", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(GT_ETHERADDR)
};
PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_ETHERADDR_PTR_maskPtr = {
     "maskPtr", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(GT_ETHERADDR)
};
PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_U16_udpPort = {
...
PRV_CPSS_LOG_FUNC_PARAM_STC * cpssDxChTtiFcoeExceptionConfiguratiosEnableSet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_CPSS_DXCH_TTI_FCOE_EXCEPTION_ENT_exceptionType,
    &DX_IN_GT_BOOL_enable
};
PRV_CPSS_LOG_FUNC_PARAM_STC * cpssDxChTtiFcoeExceptionConfiguratiosEnableGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_CPSS_DXCH_TTI_FCOE_EXCEPTION_ENT_exceptionType,
    &DX_OUT_GT_BOOL_PTR_enablePtr
};
PRV_CPSS_LOG_FUNC_PARAM_STC * cpssDxChTtiFcoeExceptionCountersGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_CPSS_DXCH_TTI_FCOE_EXCEPTION_ENT_exceptionType,
...
PRV_CPSS_LOG_FUNC_PARAM_STC * cpssDxChTtiEcnCpuCodeGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_CPSS_NET_RX_CPU_CODE_ENT_PTR_cpuCodePtr
};
PRV_CPSS_LOG_FUNC_PARAM_STC * cpssDxChTtiEcnPacketCommandGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_CPSS_PACKET_CMD_ENT_PTR_commandPtr
};
...
PRV_CPSS_LOG_FUNC_PARAM_STC * cpssDxChTtiPortGroupRuleActionUpdate_PARAMS[] =  {
    ...
    &DX_IN_GT_PORT_GROUPS_BMP_portGroupsBmp,
    &DX_IN_GT_U32_index,
    &DX_IN_CPSS_DXCH_TTI_ACTION_TYPE_ENT_actionType,
    &DX_IN_CPSS_DXCH_TTI_ACTION_UNT_PTR_actionPtr
};
...
PRV_CPSS_LOG_FUNC_PARAM_STC * cpssDxChTtiPortGroupRuleGet_PARAMS[] =  {
    ...
    &DX_IN_CPSS_DXCH_TTI_ACTION_TYPE_ENT_actionType,
    &DX_OUT_CPSS_DXCH_TTI_ACTION_UNT_PTR_actionPtr
};
...
PRV_CPSS_LOG_FUNC_PARAM_STC * cpssDxChTtiFcoeEtherTypeSet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
...
PRV_CPSS_LOG_FUNC_PARAM_STC * cpssDxChTtiTrillAdjacencyCheckEntrySet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_U32_entryIndex,
    &DX_IN_CPSS_DXCH_TTI_TRILL_ADJACENCY_STC_PTR_ttiTrillAdjacencyPtr
};
...
PRV_CPSS_LOG_FUNC_PARAM_STC * cpssDxChTtiTrillAdjacencyCheckEntryGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_U32_entryIndex,
    &DX_OUT_CPSS_DXCH_TTI_TRILL_ADJACENCY_STC_PTR_ttiTrillAdjacencyPtr
};
...
PRV_CPSS_LOG_FUNC_PARAM_STC * cpssDxChTtiFcoeEtherTypeGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
...
PRV_CPSS_LOG_FUNC_PARAM_STC * cpssDxChTtiTrillMaxVersionGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_OUT_GT_U32_PTR_maxTrillVersionPtr
};
...
static PRV_CPSS_LOG_FUNC_ENTRY_STC prvCpssDxChTtiLogLibDb[] = {
    ...
    {"cpssDxChTtiTrillAdjacencyCheckEntrySet", 3, cpssDxChTtiTrillAdjacencyCheckEntrySet_PARAMS, NULL},
    {"cpssDxChTtiTrillAdjacencyCheckEntryGet", 3, cpssDxChTtiTrillAdjacencyCheckEntryGet_PARAMS, NULL},
    ...
    {"cpssDxChTtiFcoeAssignVfIdEnableSet", 3, prvCpssLogGenDevNumPortNumEnable_PARAMS, NULL},
    {"cpssDxChTtiFcoeAssignVfIdEnableGet", 3, prvCpssLogGenDevNumPortNumEnablePtr_PARAMS, NULL},
    ...
    {"cpssDxChTtiEcnPacketCommandGet", 2, cpssDxChTtiEcnPacketCommandGet_PARAMS, NULL},
    {"cpssDxChTtiEcnCpuCodeSet", 2, prvCpssLogGenDevNumCpuCode_PARAMS, NULL},
    {"cpssDxChTtiEcnCpuCodeGet", 2, cpssDxChTtiEcnCpuCodeGet_PARAMS, NULL},
};

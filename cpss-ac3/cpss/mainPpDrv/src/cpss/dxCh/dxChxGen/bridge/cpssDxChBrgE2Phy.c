...
)
{
    ...
    PRV_CPSS_ENTRY_FORMAT_TABLE_STC * fieldsInfoPtr = NULL; /* pointer to HW table's fields info */
    ...
    fieldsInfoPtr = PRV_CPSS_DXCH_PP_MAC(devNum)->tableFormatInfo[PRV_CPSS_DXCH_TABLE_FORMAT_HA_EGRESS_EPORT_1_E].fieldsInfoPtr;

...
char * prvCpssLogEnum_CPSS_DXCH_PTP_TAI_PULSE_IN_MODE_ENT[]  =
{
...
PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_CPSS_DXCH_PTP_TS_INGRESS_TIMESTAMP_QUEUE_ENTRY_STC_PTR_tsQueueEntryPtr = {
...
PRV_CPSS_LOG_FUNC_PARAM_STC * cpssDxChPtpTaiFrequencyDriftThesholdsSet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_CPSS_DXCH_PTP_TAI_ID_STC_PTR_taiIdPtr,
    &DX_IN_GT_U32_interruptThreshold,
    &DX_IN_GT_U32_adjustThreshold
};
...
PRV_CPSS_LOG_FUNC_PARAM_STC * cpssDxChPtpTaiFrequencyDriftThesholdsGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_CPSS_DXCH_PTP_TAI_ID_STC_PTR_taiIdPtr,
    &DX_OUT_GT_U32_PTR_interruptThresholdPtr,
    &DX_OUT_GT_U32_PTR_adjustThresholdPtr
};
...
PRV_CPSS_LOG_FUNC_PARAM_STC * cpssDxChPtpTaiPulseInModeSet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_CPSS_DXCH_PTP_TAI_NUMBER_ENT_taiNumber,
...
PRV_CPSS_LOG_FUNC_PARAM_STC * cpssDxChPtpTaiPulseInModeGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_CPSS_DXCH_PTP_TAI_NUMBER_ENT_taiNumber,
...
PRV_CPSS_LOG_FUNC_PARAM_STC * cpssDxChPtpTodCounterShadowSet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_CPSS_PORT_DIRECTION_ENT_direction,
    &DX_IN_CPSS_DXCH_PTP_TOD_COUNT_STC_PTR_todCounterPtr
};
...
PRV_CPSS_LOG_FUNC_PARAM_STC * cpssDxChPtpTransportSpecificTimeStampEnableSet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_CPSS_PORT_DIRECTION_ENT_direction,
    &DX_IN_GT_U32_transportSpecificVal,
    &DX_IN_GT_BOOL_enable
};
...
PRV_CPSS_LOG_FUNC_PARAM_STC * cpssDxChPtpTimestampEntryGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_CPSS_PORT_DIRECTION_ENT_direction,
    &DX_OUT_CPSS_DXCH_PTP_TIMESTAMP_ENTRY_STC_PTR_entryPtr
};
PRV_CPSS_LOG_FUNC_PARAM_STC * cpssDxChPtpTodCounterShadowGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_CPSS_PORT_DIRECTION_ENT_direction,
    &DX_OUT_CPSS_DXCH_PTP_TOD_COUNT_STC_PTR_todCounterPtr
};
...
PRV_CPSS_LOG_FUNC_PARAM_STC * cpssDxChPtpTsDelayEgressPipeDelayGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_PHYSICAL_PORT_NUM_portNum,
    &DX_OUT_GT_32_PTR_egrPipeDelayCorrPtr
};

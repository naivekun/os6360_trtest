...
char * prvCpssLogEnum_CPSS_DXCH_PCL_ACTION_EGRESS_PHA_THREAD_ID_ASSIGNMENT_MODE_ENT[]  =
{
...
char * prvCpssLogEnum_CPSS_DXCH_PCL_ACTION_EGRESS_PHA_THREAD_TYPE_ENT[]  =
{
...
PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_CPSS_DXCH_PCL_EGRESS_TARGET_PORT_SELECTION_MODE_ENT_PTR_portSelectionModePtr = {
...
PRV_CPSS_LOG_FUNC_PARAM_STC * cpssDxChPclRulesDump_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_PORT_GROUPS_BMP_portGroupsBmp,
    &DX_IN_CPSS_PCL_RULE_SIZE_ENT_ruleSize,
...
PRV_CPSS_LOG_FUNC_PARAM_STC * cpssDxChPclRuleMatchCounterSet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_U32_counterIndex,
    &DX_IN_GT_U32_counterValue
};
...
PRV_CPSS_LOG_FUNC_PARAM_STC * cpssDxChPclEgressSubLookupPhaInfoSet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_U32_subLookupNum,
    &DX_IN_GT_U32_HEX_phaMetadataMask,
    &DX_IN_GT_U32_HEX_phaThreadIdMask
};
PRV_CPSS_LOG_FUNC_PARAM_STC * cpssDxChPclEgressSubLookupPhaInfoGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_U32_subLookupNum,
...
PRV_CPSS_LOG_FUNC_PARAM_STC * cpssDxChPclTcamRuleSizeModeGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_OUT_GT_BOOL_PTR_mixedRuleSizeModePtr,
    &DX_OUT_CPSS_PCL_RULE_SIZE_ENT_PTR_ruleSizePtr
};
...
static PRV_CPSS_LOG_FUNC_ENTRY_STC prvCpssDxChPclLogLibDb[] = {
    ...
    {"cpssDxChPclRulesDump", 5, cpssDxChPclRulesDump_PARAMS, NULL},
};

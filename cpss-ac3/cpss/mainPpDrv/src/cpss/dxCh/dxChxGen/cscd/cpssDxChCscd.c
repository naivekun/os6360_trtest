...
)
{
    ...
    if(PRV_CPSS_DXCH_PP_HW_INFO_E_ARCH_SUPPORTED_MAC(devNum) == GT_TRUE)
    {
        *hwDataPtr = 0;
        ...
        numBitsForLinkNum = PRV_CPSS_SIP_6_CHECK_MAC(devNum)    ? 10 :
...
/**
* @internal internal_cpssDxChCscdHyperGInternalPortModeSet function
* @endinternal
*
* @brief   Change HyperG.stack internal port speed.
*
...
*
* @param[in] devNum                   - physical device number
* @param[in] portNum                  - cascade HyperG port to be configured
* @param[in] mode                     - HyperG.Stack Port Speed 10Gbps or 12Gbps
*
* @retval GT_OK                    - on success
* @retval GT_BAD_PARAM             - on wrong port number or device
* @retval GT_HW_ERROR              - on hardware error
...
/**
* @internal cpssDxChCscdHyperGInternalPortModeSet function
* @endinternal
*
* @brief   Change HyperG.stack internal port speed.
*
...
/**
* @internal internal_cpssDxChCscdHyperGInternalPortModeGet function
* @endinternal
*
* @brief   Get status of HyperG port mode.
*
* @note   APPLICABLE DEVICES:      DxCh1; DxCh1_Diamond; DxCh2.
* @note   NOT APPLICABLE DEVICES:  DxCh3; xCat; xCat3; Lion; xCat2; Lion2; Bobcat2; Caelum; Bobcat3; Aldrin2; Falcon; Aldrin; AC3X.
*
...
* @param[in] portNum                  - cascade HyperG port to be configured
*
* @param[out] modePtr                  - HyperG.Stack Port Speed 10Gbps or 12Gbps
*
* @retval GT_OK                    - on success
* @retval GT_BAD_PARAM             - on wrong port number or device
* @retval GT_HW_ERROR              - on hardware error
...
/**
* @internal cpssDxChCscdHyperGInternalPortModeGet function
* @endinternal
*
* @brief   Get status of HyperG port mode.
*
...
/**
* @internal cscdXsmiPortConfigurationSet function
* @endinternal
*
* @brief   Set XSMI registers for XG PHY ports
*
* @note   APPLICABLE DEVICES:      DxCh1; DxCh1_Diamond; DxCh2; DxCh3; xCat; xCat3; Lion; xCat2; Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon.
* @note   NOT APPLICABLE DEVICES:  None.
*
* @param[in] devNum                   - physical device number
* @param[in] portNum                  - cascade HyperG port to be configured
* @param[in] xsmiActionPtr            - pointer to XSMI address and value array
* @param[in] xsmiActionSize           - XSMI address and value array size
*
* @retval GT_OK                    - on success
* @retval GT_BAD_PARAM             - on wrong port number or device
* @retval GT_HW_ERROR              - on hardware error
...
*                                                             packet is Multicast.(APPLICABLE DEVICES: Falcon).
*
* @retval GT_OK                    - on success
* @retval GT_BAD_PARAM             - on wrong device or port
* @retval GT_HW_ERROR              - on hardware error
...
)
{
    ...
    PRV_CPSS_DXCH_COS_CHECK_EXTENDED_TC_MAC(devNum, newTc);
    PRV_CPSS_DXCH_COS_DP_TO_HW_CHECK_AND_CONVERT_MAC(
    ...
    if(PRV_CPSS_SIP_5_20_CHECK_MAC(devNum))
    {
        ...
        return prvCpssDxChHwEgfQagTcDpMapperByParamsSet(devNum,
                                                        ...
                                                        targetPortTcProfile,
                                                        sourcePortTcProfile,
                                                        newDp, newTc, newPfcTc,mcastPriority);
    }
...
)
{
    ...
    CPSS_API_LOCK_MAC(devNum,PRV_CPSS_FUNCTIONALITY_CONFIGURATION_CNS);
    CPSS_LOG_API_ENTER_MAC((funcId, devNum, tcDpRemappingPtr, newTc, newDp,mcastPriority));

    rc = internal_cpssDxChCscdQosTcDpRemapTableSet(devNum, tcDpRemappingPtr, newTc, newDp, newPfcTc,mcastPriority);

    CPSS_LOG_API_EXIT_MAC(funcId, rc);
    CPSS_APP_SPECIFIC_CB_MAC((funcId, rc, devNum, tcDpRemappingPtr, newTc, newDp,mcastPriority));
    CPSS_API_UNLOCK_MAC(devNum,PRV_CPSS_FUNCTIONALITY_CONFIGURATION_CNS);
...
)
{
    ...
    CPSS_API_LOCK_MAC(devNum,PRV_CPSS_FUNCTIONALITY_CONFIGURATION_CNS);
    CPSS_LOG_API_ENTER_MAC((funcId, devNum, tcDpRemappingPtr, remappedTcPtr, remappedDpPtr,remappedMcastPriorityPtr));

    rc = internal_cpssDxChCscdQosTcDpRemapTableGet(devNum, tcDpRemappingPtr, remappedTcPtr, remappedDpPtr, remappedPfcTcPtr,remappedMcastPriorityPtr);

    CPSS_LOG_API_EXIT_MAC(funcId, rc);
    CPSS_APP_SPECIFIC_CB_MAC((funcId, rc, devNum, tcDpRemappingPtr, remappedTcPtr, remappedDpPtr,remappedMcastPriorityPtr));
    CPSS_API_UNLOCK_MAC(devNum,PRV_CPSS_FUNCTIONALITY_CONFIGURATION_CNS);
...
)
{
    ...
    PRV_CPSS_NOT_APPLICABLE_DEV_CHECK_MAC(devNum,
         CPSS_CH1_E| CPSS_CH1_DIAMOND_E | CPSS_CH2_E | CPSS_CH3_E | CPSS_XCAT_E | CPSS_XCAT3_E |
         CPSS_LION_E | CPSS_XCAT2_E | CPSS_LION2_E | CPSS_BOBCAT2_E | CPSS_CAELUM_E | CPSS_ALDRIN_E |
...
)
{
    ...
    PRV_CPSS_DXCH_DEV_CHECK_MAC(devNum);
    PRV_CPSS_NOT_APPLICABLE_DEV_CHECK_MAC(devNum,
         CPSS_CH1_E | CPSS_CH1_DIAMOND_E | CPSS_CH2_E | CPSS_CH3_E | CPSS_XCAT_E | CPSS_XCAT3_E | CPSS_XCAT2_E | CPSS_LION_E | CPSS_BOBCAT2_E | CPSS_CAELUM_E | CPSS_ALDRIN_E | CPSS_AC3X_E | CPSS_BOBCAT3_E | CPSS_ALDRIN2_E | CPSS_FALCON_E);
    PRV_CPSS_DXCH_PHY_PORT_OR_CPU_PORT_CHECK_MAC(devNum, portNum);

...
PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_CPSS_DXCH_CSCD_PORT_CRC_MODE_ENT_PTR_crcModePtr = {
     "crcModePtr", PRV_CPSS_LOG_PARAM_OUT_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(CPSS_DXCH_CSCD_PORT_CRC_MODE_ENT)
};
PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_CPSS_DXCH_CSCD_PORT_QOS_DSA_TRUST_MODE_ENT_PTR_portQosDsaTrustModePtr = {
...
PRV_CPSS_LOG_FUNC_PARAM_STC * cpssDxChCscdHyperGInternalPortModeSet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_PHYSICAL_PORT_NUM_portNum,
    &DX_IN_CPSS_DXCH_CSCD_HYPER_G_PORT_MODE_ENT_mode
};
...
PRV_CPSS_LOG_FUNC_PARAM_STC * cpssDxChCscdPortTcProfiletSet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_PHYSICAL_PORT_NUM_portNum,
    &DX_IN_CPSS_PORT_DIRECTION_ENT_portDirection,
...
PRV_CPSS_LOG_FUNC_PARAM_STC * cpssDxChCscdPortTcProfiletGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_PHYSICAL_PORT_NUM_portNum,
    &DX_IN_CPSS_PORT_DIRECTION_ENT_portDirection,
    &DX_OUT_CPSS_DXCH_PORT_PROFILE_ENT_PTR_portProfilePtr
};
PRV_CPSS_LOG_FUNC_PARAM_STC * cpssDxChCscdPortAcceptFdbSaLookupSkipEnableSet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_PHYSICAL_PORT_NUM_portNum,
...
PRV_CPSS_LOG_FUNC_PARAM_STC * cpssDxChCscdHyperGInternalPortModeGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_PHYSICAL_PORT_NUM_portNum,
    &DX_OUT_CPSS_DXCH_CSCD_HYPER_G_PORT_MODE_ENT_PTR_modePtr
};
...
PRV_CPSS_LOG_FUNC_PARAM_STC * cpssDxChCscdPortAcceptFdbSaLookupSkipEnableGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_PHYSICAL_PORT_NUM_portNum,
...
PRV_CPSS_LOG_FUNC_PARAM_STC * cpssDxChCscdCentralizedChassisRemotePhysicalPortVlanTagTpidSet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
...
PRV_CPSS_LOG_FUNC_PARAM_STC * cpssDxChCscdCentralizedChassisRemotePhysicalPortVlanTagTpidGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
...
static PRV_CPSS_LOG_FUNC_ENTRY_STC prvCpssDxChCscdLogLibDb[] = {
    ...
    {"cpssDxChCscdQosTcDpRemapTableSet", 6, cpssDxChCscdQosTcDpRemapTableSet_PARAMS, NULL},
    {"cpssDxChCscdQosTcDpRemapTableGet", 6, cpssDxChCscdQosTcDpRemapTableGet_PARAMS, NULL},

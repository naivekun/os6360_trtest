...
char * prvCpssLogEnum_CPSS_DXCH_LPM_LEAF_ENTRY_PRIORITY_TYPE_ENT[]  =
{
...
PRV_CPSS_LOG_FUNC_PARAM_STC * cpssDxChLpmMemoryModeGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,

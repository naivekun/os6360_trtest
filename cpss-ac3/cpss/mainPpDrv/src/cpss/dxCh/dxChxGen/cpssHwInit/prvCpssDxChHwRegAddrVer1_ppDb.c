...
*/
static PRV_CPSS_DXCH_UNITID_UNITBASEADDR_STC prvDxChAldrin2UnitsIdUnitBaseAddrArr[] =
{
     { PRV_CPSS_DXCH_UNIT_TTI_E,                PRV_CPSS_DXCH_BOBCAT3_BASE_ADDRESS_TTI_CNS                              }
    ,{ PRV_CPSS_DXCH_UNIT_PCL_E,                PRV_CPSS_DXCH_BOBCAT3_BASE_ADDRESS_IPCL_CNS                             }
    ,{ PRV_CPSS_DXCH_UNIT_L2I_E,                PRV_CPSS_DXCH_BOBCAT3_BASE_ADDRESS_L2I_CNS                              }
...
{
    /* table filled at runtime by prvDxChHwRegAddrFalconDbInit() */
    { PRV_CPSS_DXCH_UNIT_LAST_E,               NON_VALID_ADDR_CNS                                                 }
};

/* GT_U32 devUnitsBaseAddr  [PRV_CPSS_DXCH_UNIT_LAST_E + 1];  *//* Lion2 unit base address array */
...
GT_U32 prvDxChAldrin2UnitsBaseAddr[PRV_CPSS_DXCH_UNIT_LAST_E + 1];/* Aldrin2 unit base address array */
GT_U32 prvDxChFalconUnitsBaseAddr [PRV_CPSS_DXCH_UNIT_LAST_E + 1];/* Falcon unit base address array */

static PRV_CPSS_DXCH_UNITID_UNITBASEADDR_x_TABLE2FILL_STC prv_UnitId_UnitBaseDrrList_x_UnitBasedArrTbl []  =
{
      /* { CPSS_PP_FAMILY_DXCH_LION2_E,    CPSS_PP_SUB_FAMILY_NONE_E,          &prvDxChLion2UnitsIdUnitBaseAddrArr[0],       &devUnitsBaseAddr[0]   } */
     ...
     ,{ CPSS_PP_FAMILY_DXCH_AC3X_E,     CPSS_PP_SUB_FAMILY_NONE_E,          &prvDxChAldrinUnitsIdUnitBaseAddrArr[0],      &prvDxChAldrinUnitsBaseAddr[0]    }
     ,{ CPSS_PP_FAMILY_DXCH_ALDRIN2_E,  CPSS_PP_SUB_FAMILY_NONE_E,          &prvDxChAldrin2UnitsIdUnitBaseAddrArr[0],     &prvDxChAldrin2UnitsBaseAddr[0] }
     ,{ CPSS_PP_FAMILY_DXCH_FALCON_E,   CPSS_PP_SUB_FAMILY_NONE_E,          &prvDxChFalconUnitsIdUnitBaseAddrArr[0],      &prvDxChFalconUnitsBaseAddr[0] }
...
)
{
    ...
    if (prv_unitBaseWs.isInit == GT_FALSE)
    {
        ...
        for (ppIdx = 0 ; prv_unitBaseWs.initTblList[ppIdx].devFamily != CPSS_MAX_FAMILY; ppIdx++)
        {
            ...
            currDevUnitsBaseAddr = prv_unitBaseWs.initTblList[ppIdx].devUnitsBaseAddr;
...
)
{
    ...
    for (ppIdx = 0 ; prv_unitBaseWs.initTblList[ppIdx].devFamily != CPSS_MAX_FAMILY; ppIdx++)
    {
        ...
        {
            *devUnitsBaseAddrPtrPtr = prv_unitBaseWs.initTblList[ppIdx].devUnitsBaseAddr;
            return GT_OK;
        }
    }

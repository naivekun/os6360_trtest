...
)
{
    ...
    (void)(*additionalRegDupPtr);
    (void)(*isAdditionalRegDupNeededPtr);
    (void)(portGroupId);
...
)
{
       ...
       PRV_CPSS_PP_MAC(devNum)->devFamily == CPSS_PP_FAMILY_DXCH_FALCON_E)
    {
        ...
        /* allow 2 additional CPU ports */
        /* compensation due to WA in : prvCpssFalconInitParamsSet */
        numOfPorts += 2;
    }
...
*         struct for devices that belong to REGS_FAMILY_1 registers set.
*
* @note   APPLICABLE DEVICES:      DxCh1; DxCh1_Diamond; DxCh2; DxCh3; xCat; xCat3; Lion; xCat2; Lion.
* @note   NOT APPLICABLE DEVICES:  Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon.
*
* @param[in,out] addrPtr                  - pointer to registers struct
* @param[in,out] addrPtr                  - registers struct with regs init
...
)
{
    ...
    PRV_CPSS_NOT_APPLICABLE_DEV_CHECK_MAC(devNum, CPSS_BOBCAT2_E | CPSS_BOBCAT3_E | CPSS_ALDRIN2_E | CPSS_FALCON_E | CPSS_CAELUM_E | CPSS_ALDRIN_E | CPSS_AC3X_E);
...
* @note   NOT APPLICABLE DEVICES:  DxCh1; DxCh1_Diamond; DxCh2; Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon.
*
* @param[in] devNum                   - The PP's device number to init the struct for.
* @param[in,out] addrPtr                  - pointer to registers struct
* @param[in,out] addrPtr                  - registers struct with regs init
...
)
{
    ...
    for (i = 0; (i < PRV_CPSS_PP_MAC(devNum)->numOfPorts); i++)
    {
        ...
        if ((PRV_CPSS_PP_MAC(devNum)->devFamily == CPSS_PP_FAMILY_DXCH_LION_E) &&
            (PRV_CPSS_GLOBAL_PORT_TO_LOCAL_PORT_CONVERT_MAC((GT_U8)devNum,i) == 10))
        {
...
)
{
    ...
    PRV_CPSS_NOT_APPLICABLE_DEV_CHECK_MAC(devNum,
         CPSS_CH1_E | CPSS_CH1_DIAMOND_E | CPSS_CH2_E | CPSS_BOBCAT2_E | CPSS_BOBCAT3_E | CPSS_ALDRIN2_E | CPSS_FALCON_E | CPSS_CAELUM_E | CPSS_ALDRIN_E | CPSS_AC3X_E);
...
)
{
    ...
    PRV_CPSS_DXCH_DEV_CHECK_MAC(devNum);
    PRV_CPSS_NOT_APPLICABLE_DEV_CHECK_MAC(devNum, CPSS_CH1_E | CPSS_CH1_DIAMOND_E | CPSS_BOBCAT2_E | CPSS_BOBCAT3_E | CPSS_ALDRIN2_E | CPSS_FALCON_E | CPSS_CAELUM_E| CPSS_ALDRIN_E | CPSS_AC3X_E);
...
/**
* @internal xCatDebugBusRegsInit function
* @endinternal
*
* @brief   This function initializes the Debug Bus registers struct for xCat
*         and xCat2 devices.
* @param[in] devNum                   - The PP's device number.
* @param[in,out] addrPtr                  - pointer to registers struct
* @param[in,out] addrPtr                  - registers struct with regs init
...
*
* @note   APPLICABLE DEVICES:      Lion; xCat2; Lion2.
* @note   NOT APPLICABLE DEVICES:  DxCh1; DxCh1_Diamond; DxCh2; DxCh3; xCat; xCat3; Bobcat2; Caelum; Aldrin Bobcat3; Aldrin2; Falcon.
*
* @param[in] devNum                   - The PP's device number to init the struct for.
* @param[in,out] addrPtr                  - pointer to registers struct
* @param[in,out] addrPtr                  - registers struct with buffer management regs init
...
*
* @note   APPLICABLE DEVICES:      xCat; xCat3; xCat2; Lion; Lion2.
* @note   NOT APPLICABLE DEVICES:  DxCh1; DxCh1_Diamond; DxCh2; DxCh3; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon.
*
* @param[in,out] addrPtr                  - pointer to registers struct
* @param[in,out] addrPtr                  - registers struct with bridge regs init
...
/**
* @internal xCat2DescriptorRegsInit function
* @endinternal
*
* @brief   This function initializes the Descriptor registers.
*
* @note   APPLICABLE DEVICES:      xCat2.
* @note   NOT APPLICABLE DEVICES:  DxCh1; DxCh1_Diamond; DxCh2; DxCh3, xCat; xCat3; Lion; Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon.
*
* @param[in,out] addrPtr                  - pointer to registers struct
* @param[in,out] addrPtr                  - registers struct with bridge regs init
*                                       None.
...
)
{
    ...
    PRV_CPSS_DXCH_DEV_CHECK_MAC(devNum);
    PRV_CPSS_NOT_APPLICABLE_DEV_CHECK_MAC(devNum,
         CPSS_CH1_E | CPSS_CH1_DIAMOND_E | CPSS_CH2_E | CPSS_CH3_E | CPSS_BOBCAT2_E | CPSS_BOBCAT3_E | CPSS_ALDRIN2_E | CPSS_FALCON_E | CPSS_CAELUM_E| CPSS_ALDRIN_E | CPSS_AC3X_E);
    ...
    /* skip configuration for Lion; Lion2 */
    if((PRV_CPSS_PP_MAC(devNum)->devFamily != CPSS_PP_FAMILY_DXCH_LION_E)&&
       (PRV_CPSS_PP_MAC(devNum)->devFamily != CPSS_PP_FAMILY_DXCH_LION2_E))
    {
...
)
{
    ...
    PRV_CPSS_DXCH_DEV_CHECK_MAC(devNum);
    PRV_CPSS_NOT_APPLICABLE_DEV_CHECK_MAC(devNum,
         CPSS_CH1_E | CPSS_CH1_DIAMOND_E | CPSS_CH2_E | CPSS_CH3_E | CPSS_XCAT_E | CPSS_XCAT3_E | CPSS_BOBCAT2_E | CPSS_BOBCAT3_E | CPSS_ALDRIN2_E | CPSS_FALCON_E | CPSS_CAELUM_E| CPSS_ALDRIN_E | CPSS_AC3X_E);
...
/**
* @internal xCat2DfxUnitsRegsInit function
* @endinternal
*
* @brief   This function initializes the registers DFX Units struct for xCat2
*
* @note   APPLICABLE DEVICES:      xCat2.
* @note   NOT APPLICABLE DEVICES:  DxCh1; DxCh1_Diamond; DxCh2; DxCh3; xCat; xCat3; Lion; Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon.
*
...
/**
* @internal xCat2TxqRegsInit function
* @endinternal
*
* @brief   This function initializes the TXQ registers -- xCat2
*
* @note   APPLICABLE DEVICES:      xCat2.
* @note   NOT APPLICABLE DEVICES:  DxCh1; DxCh1_Diamond; DxCh2; DxCh3; xCat; xCat3; Lion; Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon.
*
* @param[in,out] addrPtr                  - pointer to registers struct
* @param[in,out] addrPtr                  - registers struct with TXQ regs init
*                                       None.
*/
...
*
* @note   APPLICABLE DEVICES:      Lion2.
* @note   NOT APPLICABLE DEVICES:  DxCh1; DxCh1_Diamond; DxCh2; DxCh3; xCat; Lion; xCat2; xCat3; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon.
*
* @param[in] devNum                   - The PP's device number to init the struct for.
* @param[in,out] addrPtr                  - pointer to registers struct
* @param[in,out] addrPtr                  - registers struct with regs init
...
)
{
    ...
    PRV_CPSS_NOT_APPLICABLE_DEV_CHECK_MAC(devNum,
         ...
         CPSS_BOBCAT2_E | CPSS_BOBCAT3_E | CPSS_ALDRIN2_E | CPSS_FALCON_E | CPSS_CAELUM_E| CPSS_ALDRIN_E | CPSS_AC3X_E);
...
)
{
    ...
    */
    ...
    if(PRV_CPSS_SIP_6_CHECK_MAC(devNum))
    {
        falconSerdesRegsInit(devNum,regsAddrPtr);
    }
    else
#endif
    {
...
*
* @note   APPLICABLE DEVICES:      xCat; Lion; xCat2; Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; xCat3.
* @note   NOT APPLICABLE DEVICES:  DxCh1; DxCh1_Diamond; DxCh2; DxCh3.
*
* @param[in] devNum                   - physical device number

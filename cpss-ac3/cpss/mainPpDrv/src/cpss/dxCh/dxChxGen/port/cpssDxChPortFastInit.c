...
* @note   NOT APPLICABLE DEVICES:  DxCh1; DxCh1_Diamond; DxCh2; Lion2.
*
...
/**
* @internal fastPortGeConfig function
* @endinternal
*
* @brief   Make GE specific configurations
*
* @note   APPLICABLE DEVICES:      Lion.
* @note   NOT APPLICABLE DEVICES:  DxCh1; DxCh1_Diamond; DxCh2; DxCh3; xCat; xCat3; xCat2; Lion2.
*
...
/**
* @internal fastPortXpcsActiveLanesSet function
* @endinternal
*
* @brief   Configure number of active XPCS lanes accordingly to interface mode
*
* @note   APPLICABLE DEVICES:      Lion.
* @note   NOT APPLICABLE DEVICES:  DxCh1; DxCh1_Diamond; DxCh2; DxCh3; xCat; xCat3; xCat2; Lion2.
*
...
/**
* @internal fastPortInitPhase1 function
* @endinternal
*
* @brief   First phase of fast port init
*
* @note   APPLICABLE DEVICES:      Lion.
* @note   NOT APPLICABLE DEVICES:  DxCh1; DxCh1_Diamond; DxCh2; DxCh3; xCat; xCat3; xCat2; Lion2.
*
...
/**
* @internal fastPortInitPhase2 function
* @endinternal
*
* @brief   Second phase of fast port init
*
* @note   APPLICABLE DEVICES:      Lion.
* @note   NOT APPLICABLE DEVICES:  DxCh1; DxCh1_Diamond; DxCh2; DxCh3; xCat; xCat3; xCat2; Lion2.
*
...
/**
* @internal macSpeedSet function
* @endinternal
*
* @brief   Configure mac and if needed WA
*
* @note   APPLICABLE DEVICES:      Lion.
* @note   NOT APPLICABLE DEVICES:  DxCh1; DxCh1_Diamond; DxCh2; DxCh3; xCat; xCat3; xCat2; Lion2.
*
...
/**
* @internal serdesFastConfig function
* @endinternal
*
* @brief   Write to HW serdes power sequence
*
* @note   APPLICABLE DEVICES:      xCat; Lion; xCat2.
* @note   NOT APPLICABLE DEVICES:  DxCh1; DxCh1_Diamond; DxCh2; DxCh3; xCat3; Lion2.
*
* @param[in] devNum                   - physical device number
...
* @param[in] cfgStep                  - current step in serdes power up sequence
*
* @retval GT_OK                    - on success
...
)
{
    ...
    globalLaneNum = (PRV_CPSS_IS_LION_STYLE_MULTI_PORT_GROUPS_DEVICE_MAC(devNum) == 0) ? 0 :
...
/**
* @internal validityCheck function
* @endinternal
*
* @brief   Check if required configuration alowed for port.
*
* @note   APPLICABLE DEVICES:      xCat; xCat3; Lion; xCat2; Lion2.
* @note   NOT APPLICABLE DEVICES:  DxCh1; DxCh1_Diamond; DxCh2; DxCh3.
*
* @param[in] devNum                   - physical device number
* @param[in] portsBmp                 - physical port number (not CPU port)
* @param[in] ifMode                   - interface mode
...
/**
* @internal internal_cpssDxChPortsFastInit function
* @endinternal
*
...
)
{
    ...
    rc = validityCheck(devNum, *portsBmpPtr, ifMode, speed);
    if(rc != GT_OK)
    {
        return rc;
    }

    rc = fastPortInitPhase1(devNum, *portsBmpPtr, ifMode, speed);
    if(rc != GT_OK)
    {
        return rc;
    }

    rc = fastPortInitPhase2(devNum, *portsBmpPtr, ifMode, speed);
    if(rc != GT_OK)
    {
        return rc;
    }
...
)
{
    ...
    CPSS_LOG_API_ENTER_MAC((funcId, devNum, portsBmpPtr, ifMode, speed));

    rc = internal_cpssDxChPortsFastInit(devNum, portsBmpPtr, ifMode, speed);

    CPSS_LOG_API_EXIT_MAC(funcId, rc);
    CPSS_APP_SPECIFIC_CB_MAC((funcId, rc, devNum, portsBmpPtr, ifMode, speed));

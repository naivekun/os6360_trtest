...
PORT_MANULAL_TXQ_CREDIT_STC prv_txqPortManualCredit = { (GT_U32)(~0),(CPSS_PORT_SPEED_ENT)(-1), 0};
...
{
    prv_txqPortManualCredit.portNum     = portNum;
    prv_txqPortManualCredit.speed       = speed;
    prv_txqPortManualCredit.txqCredits  = txqCredits;
    return GT_OK;
}
...
)
{
    ...
    if (portMapShadowPtr->portMap.trafficManagerEn == GT_FALSE)
    {
         ...
         *------------------------------------------------------------------------------*/
        if (portNum == prv_txqPortManualCredit.portNum && speed == prv_txqPortManualCredit.speed)
        {
            PRV_DXCH_BCAT2_RESOURCE_LIST_Append(resConfigPtr,BC2_PORT_FLD_TXDMA_SCDMA_TxQDescriptorCredit,          portMapShadowPtr->portMap.txDmaNum, prv_txqPortManualCredit.txqCredits);
        }
        else
        {

...
/**
* @internal prvCpssDxChXpcsLanesDisparityErrStatus function
* @endinternal
*
* @brief   Read value of disparity error counter
*
* @param[in] devNum                   - device number
* @param[in] portNum                  - port number
*
* @param[out] statusPtr                - disparity error happend on one of first 4 XPCS lanes
*                                      GT_TRUE - happend,
...
* @retval GT_HW_ERROR              - hw error
*
* @note There are 6 XPCS lanes, but currently supported port interface modes use
*       just 4.
*
*/
...
/**
* @internal prvCpssDxChLocalSerdesLanesFree function
* @endinternal
*
* @brief   This functions checks if even port isn't occupaing serdes lanes of given
*         odd port and if it does the tries to release them
* @param[in] devNum                   - device number
* @param[in] portNum                  - port number
*
* @param[out] serdesStatusPtr          - local serdes are:
*                                      GT_TRUE - free,
...
/**
* @internal prvCpssDxChXLGDetect function
* @endinternal
*
* @brief   The function checks if XLG interface mode and 40G data speed
...
/**
* @internal prvCpssDxChXgmii20GDetect function
* @endinternal
*
* @brief   The function checks if XGMII (XAUI) interface mode and 20G data speed
*         compatible with given port interface
* @param[in] devNum                   - device number
* @param[in] portNum                  - port number
*
...
* @note   NOT APPLICABLE DEVICES:  DxCh1; DxCh1_Diamond; DxCh2; DxCh3; Lion; xCat; xCat3.
*
* @param[in] devNum                   - device number
* @param[in] portNum                  - port number
*
...
/**
* @internal internal_cpssDxChPortGePrbsIntReplaceEnableSet function
* @endinternal
*
...
/**
* @internal internal_cpssDxChPortGePrbsIntReplaceEnableGet function
* @endinternal
*
...
*
* @note   APPLICABLE DEVICES:      Lion; xCat; xCat3; Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon.

...
/**
* @internal xcatGeSpecificConfig function
* @endinternal
*
* @brief   Configure GE MAC unit of XCAT/XCAT2 ports
*
* @param[in] devNum                   - physical device number
* @param[in] portNum                  - physical port number
* @param[in] speed                    - port speed
...
/**
* @internal xCatSpeedSet function
* @endinternal
*
...
)
{
    ...
    PRV_CPSS_NOT_APPLICABLE_DEV_CHECK_MAC(devNum, CPSS_CH1_E | CPSS_CH1_DIAMOND_E
                                        ...
                                        | CPSS_LION2_E | CPSS_BOBCAT2_E | CPSS_CAELUM_E | CPSS_ALDRIN_E | CPSS_AC3X_E
...
/**
* @internal lionSerdesSpeedSet function
* @endinternal
*
...
/**
* @internal lionSpeedSet function
* @endinternal
*
* @brief   Sets speed for specified port on specified xcat/xcat2 device.
*
        ...
        case CPSS_PORT_INTERFACE_MODE_CR4_E:
            switch(speed)
            {
                ...
                case CPSS_PORT_SPEED_100G_E:
                    if(CPSS_PORT_INTERFACE_MODE_KR_E != ifMode || CPSS_PORT_INTERFACE_MODE_CR4_E != ifMode)
                    {
                        CPSS_LOG_ERROR_AND_RETURN_MAC(GT_NOT_SUPPORTED, LOG_ERROR_NO_MSG);
                    }
                break;
...
/**
* @internal cheetah1_3_GePortSpeedSet function
* @endinternal
*
* @brief   Sets speed for specified GE port on specified device.
*
...
/**
* @internal cheetah3_XgPortSpeedSet function
* @endinternal
*
* @brief   Sets speed for specified XG port on specified DxCh3 device.
*
...
/**
* @internal cheetah1_2_XgPortSpeedSet function
* @endinternal
*
* @brief   Sets speed for specified XG port on specified device.
*
...
/**
* @internal cheetah1_3_PortSpeedGet function
* @endinternal
*
* @brief   Gets speed for specified port on specified device.
*
...
* @brief   Gets speed for specified flex link on specified device.
*
* @note   APPLICABLE DEVICES:      xCat3; Lion; Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon.
...
/**
* @internal prvCpssDxChLionPortSpeedHwGet function
* @endinternal
*
...
* @param[in] portNum                  - physical port number
*
* @param[out] speedPtr                 - pointer to configured port speed (in case of GE when auto-neg.
...
* @brief   Gets from HW speed for specified port on specified device.
*
* @note   APPLICABLE DEVICES:      Lion; xCat; Lion2; xCat2; Bobcat2; xCat3; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon.
* @note   NOT APPLICABLE DEVICES:  DxCh1; DxCh1_Diamond; DxCh2; DxCh3.
*
* @param[in] devNum                   - physical device number
* @param[in] portNum                  - physical port number

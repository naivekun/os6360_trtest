...
/**
* @internal internal_cpssDxChPortSyncEtherSecondRecoveryClkEnableSet function
* @endinternal
*
...
)
{
    ...
    PRV_CPSS_NOT_APPLICABLE_DEV_CHECK_MAC(devNum,
         CPSS_CH1_E | CPSS_CH1_DIAMOND_E | CPSS_CH2_E | CPSS_CH3_E | CPSS_XCAT3_E | CPSS_LION_E | CPSS_LION2_E | CPSS_BOBCAT2_E | CPSS_CAELUM_E | CPSS_ALDRIN_E | CPSS_AC3X_E | CPSS_BOBCAT3_E | CPSS_ALDRIN2_E | CPSS_FALCON_E);
...
/**
* @internal internal_cpssDxChPortSyncEtherSecondRecoveryClkEnableGet function
* @endinternal
*
...
/**
* @internal internal_cpssDxChPortSyncEtherPllRefClkSelectSet function
* @endinternal
*
...
)
{
    ...
    PRV_CPSS_DXCH_DEV_CHECK_MAC(devNum);
    PRV_CPSS_NOT_APPLICABLE_DEV_CHECK_MAC(devNum,
         CPSS_CH1_E | CPSS_CH1_DIAMOND_E | CPSS_CH2_E | CPSS_CH3_E | CPSS_XCAT3_E | CPSS_LION2_E | CPSS_BOBCAT2_E | CPSS_CAELUM_E | CPSS_ALDRIN_E | CPSS_AC3X_E | CPSS_BOBCAT3_E | CPSS_ALDRIN2_E | CPSS_FALCON_E);
...
/**
* @internal internal_cpssDxChPortSyncEtherPllRefClkSelectGet function
* @endinternal
*
...
/**
* @internal prvCpssDxChPortSyncEtherRecoveryClkConfigSetForLion function
* @endinternal
*
...
/**
* @internal prvCpssDxChPortSyncEtherRecoveryClkConfigGetForLion function
* @endinternal
*
...
/**
* @internal internal_cpssDxChPortSyncEtherRecoveryClkDividerBypassEnableSet function
* @endinternal
*
...
)
{
    ...
    PRV_CPSS_DXCH_DEV_CHECK_MAC(devNum);
    PRV_CPSS_NOT_APPLICABLE_DEV_CHECK_MAC(devNum,
         CPSS_CH1_E | CPSS_CH1_DIAMOND_E | CPSS_CH2_E | CPSS_CH3_E | CPSS_XCAT3_E | CPSS_LION_E | CPSS_XCAT2_E | CPSS_LION2_E | CPSS_BOBCAT2_E | CPSS_CAELUM_E | CPSS_ALDRIN_E | CPSS_AC3X_E | CPSS_BOBCAT3_E | CPSS_ALDRIN2_E | CPSS_FALCON_E);
...
/**
* @internal internal_cpssDxChPortSyncEtherRecoveryClkDividerBypassEnableGet function
* @endinternal
*

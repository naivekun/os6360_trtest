...
PRV_CPSS_LOG_FUNC_PARAM_STC * cpssDxChCncPortGroupBlockClientRangesSet_PARAMS[] =  {
    ...
    &DX_IN_GT_U32_blockNum,
    &DX_IN_CPSS_DXCH_CNC_CLIENT_ENT_client,
    &DX_IN_GT_U64_HEX_indexRangesBmp
};

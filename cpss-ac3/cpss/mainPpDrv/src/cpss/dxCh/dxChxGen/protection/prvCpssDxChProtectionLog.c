...
PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_PROTECTION_LOC_STATUS_ENT_status = {
     "status", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_MAC(CPSS_DXCH_PROTECTION_LOC_STATUS_ENT)
};
PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_U32_locTableIndex = {
     "locTableIndex", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_MAC(GT_U32)
};
PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_CPSS_DXCH_PROTECTION_LOC_STATUS_ENT_PTR_statusPtr = {
     "statusPtr", PRV_CPSS_LOG_PARAM_OUT_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(CPSS_DXCH_PROTECTION_LOC_STATUS_ENT)
};
PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_GT_U32_PTR_locTableIndexPtr = {

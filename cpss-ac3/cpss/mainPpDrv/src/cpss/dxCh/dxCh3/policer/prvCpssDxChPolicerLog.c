...
PRV_CPSS_LOG_FUNC_PARAM_STC * cpssDxChPolicerDropRedModeSet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_CPSS_DROP_MODE_TYPE_ENT_dropRedMode
};
PRV_CPSS_LOG_FUNC_PARAM_STC * cpssDxCh3PolicerBillingCountersModeSet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_CPSS_DXCH3_POLICER_BILLING_CNTR_MODE_ENT_cntrMode
};
...
PRV_CPSS_LOG_FUNC_PARAM_STC * cpssDxChPolicerMeteringAnalyzerIndexSet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_CPSS_DXCH_POLICER_STAGE_TYPE_ENT_stage,
...
PRV_CPSS_LOG_FUNC_PARAM_STC * cpssDxChPolicerMeteringAnalyzerIndexGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_CPSS_DXCH_POLICER_STAGE_TYPE_ENT_stage,
    &DX_IN_CPSS_DP_LEVEL_ENT_color,
...
PRV_CPSS_LOG_FUNC_PARAM_STC * cpssDxChPolicerEntryMeterParamsCalculate_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_CPSS_DXCH_POLICER_TB_PARAMS_STC_PTR_tbInParamsPtr,
    &DX_OUT_CPSS_DXCH_POLICER_TB_PARAMS_STC_PTR_tbOutParamsPtr
};
PRV_CPSS_LOG_FUNC_PARAM_STC * cpssDxChPolicerPacketSizeModeSet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_CPSS_POLICER_PACKET_SIZE_MODE_ENT_mode
};
PRV_CPSS_LOG_FUNC_PARAM_STC * cpssDxChPolicerTokenBucketModeSet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_CPSS_POLICER_TB_MODE_ENT_mode,
    &DX_IN_CPSS_POLICER_MRU_ENT_mru
};
...
PRV_CPSS_LOG_FUNC_PARAM_STC * cpssDxChPolicerCountersSet_PARAMS[] =  {
    ...
    &DX_IN_CPSS_DXCH_POLICER_COUNTERS_STC_PTR_countersPtr
};
PRV_CPSS_LOG_FUNC_PARAM_STC * cpssDxChPolicerCountersGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_U32_counterSetIndex,
    &DX_OUT_CPSS_DXCH_POLICER_COUNTERS_STC_PTR_countersPtr
};
PRV_CPSS_LOG_FUNC_PARAM_STC * cpssDxChPolicerEntrySet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_U32_entryIndex,
    &DX_IN_CPSS_DXCH_POLICER_ENTRY_STC_PTR_entryPtr,
    &DX_OUT_CPSS_DXCH_POLICER_TB_PARAMS_STC_PTR_tbParamsPtr
};
PRV_CPSS_LOG_FUNC_PARAM_STC * cpssDxChPolicerEntryGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_U32_entryIndex,
    &DX_OUT_CPSS_DXCH_POLICER_ENTRY_STC_PTR_entryPtr
};
...
PRV_CPSS_LOG_FUNC_PARAM_STC * cpssDxCh3PolicerBillingCountersModeGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_OUT_CPSS_DXCH3_POLICER_BILLING_CNTR_MODE_ENT_PTR_cntrModePtr
};
...
PRV_CPSS_LOG_FUNC_PARAM_STC * cpssDxCh3PolicerMeteringAutoRefreshIntervalGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_OUT_GT_U32_PTR_intervalPtr
};
PRV_CPSS_LOG_FUNC_PARAM_STC * cpssDxCh3PolicerMeteringAutoRefreshRangeGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_OUT_GT_U32_PTR_startAddressPtr,
    &DX_OUT_GT_U32_PTR_stopAddressPtr
};

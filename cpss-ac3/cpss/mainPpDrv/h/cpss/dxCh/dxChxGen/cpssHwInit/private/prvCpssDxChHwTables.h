...
typedef struct{
    ...
    /** indication that base address was already aligned.(controlReg,dataReg) */
    GT_BOOL initWasDone;
...
typedef enum{
    ...
    SIP6_TTI_PHYSICAL_PORT_TABLE_FIELDS_ACCEPT_EDSA_SKIP_FDB_SA_LOOKUP_FIELD_E = SIP5_TTI_PHYSICAL_PORT_TABLE_FIELDS___LAST_VALUE___E,
...
#define SIP6_HA_TUNNEL_START_GENERIC_FIELD_SET_MAC(_dev,_hwDataArr,_fieldName,_value)    \
    U32_SET_FIELD_BY_ID_MAC(_hwDataArr,                             \
        PRV_CPSS_DXCH_PP_MAC(_dev)->tableFormatInfo[PRV_CPSS_DXCH_TABLE_FORMAT_GENERIC_TUNNEL_START_E].fieldsInfoPtr, \
        _fieldName,                                                 \
        _value)
...
typedef enum{
    ...
    /* sip6 only fields (common to ingress and to egress too)*/

...
extern PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_HSU_DATA_TYPE_ENT_dataType;
extern PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_U32_newEvReqHndl;
extern PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_U32_oldEvReqHndl;


/********* lib API DB *********/

enum {
    PRV_CPSS_LOG_FUNC_cpssHsuEventHandleUpdate_E = (CPSS_LOG_LIB_SYSTEM_RECOVERY_E << 16) | (1 << 24),

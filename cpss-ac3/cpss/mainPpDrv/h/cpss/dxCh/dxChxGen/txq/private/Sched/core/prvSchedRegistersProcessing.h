...
#define	 TM_REG_ROW_SET(field_name,shift,width,default_value, ...) \
	...
	{\
		schedSetField(TM_REGISTER_VAR_PTR(PARAM_2_OF_3(__VA_ARGS__)), shift, width, DUMMY_MACRO(PARAM_3_OF_3(__VA_ARGS__)));\
	}

#define	 TM_REG_ROW_RESET(field_name,shift,width,default_value,...) schedSetField(TM_REGISTER_VAR_ADDR(__VA_ARGS__), shift, width, default_value);
...
*/
	...
	#define	TXQ_SCHED_REGISTER_SET(register, param_name, param_value)  { TM_REGISTER_VAR_NAME(register).param_name=param_value ;}
	#define	TXQ_SCHED_REGISTER_GET(register, param_name, param_value ,casting)  { param_value = casting TM_REGISTER_VAR_NAME(register).param_name;}
	#define	TXQ_SCHED_REGISTER_RESET(register)  /* nothing to do */

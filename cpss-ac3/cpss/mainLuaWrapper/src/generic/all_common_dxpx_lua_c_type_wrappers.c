/*************************************************************************
* /local/store/yedidiaf/git/temp_embede_files/tmp_bld_cpssAPI/all_common_dxpx_lua_c_type_wrappers.c
*
* DESCRIPTION:
*       A lua type wrapper
...
*
* COMMENTS:
*       Generated at Thu Aug 30 21:14:06 2018
*       /local/store/yedidiaf/git/src/linux_cpss.super/cpss.super/cpss/mainLuaWrapper/scripts/make_type_wrapper.py -i /local/store/yedidiaf/git/temp_embede_files/tmp_bld_cpssAPI/type_info_file_dxpx -p /local/store/yedidiaf/git/src/linux_cpss.super/cpss.super/cpss/mainLuaWrapper/scripts/already_implemented.lst -X /local/store/yedidiaf/git/src/linux_cpss.super/cpss.super/cpss/mainLuaWrapper/scripts/excludelist -C /local/store/yedidiaf/git/src/linux_cpss.super/cpss.super/cpss -M /local/store/yedidiaf/git/src/linux_cpss.super/cpss.super/cpss/mainLuaWrapper/scripts/lua_C_mapping -N -F NONE -I common -I mainPxDrv -I mainPpDrv -o /local/store/yedidiaf/git/temp_embede_files/tmp_bld_cpssAPI/all_common_dxpx_lua_c_type_wrappers.c
*
...
use_prv_enum(CPSS_PORT_PA_BW_MODE_ENT);
...
enumDescr enumDescr_CPSS_PORT_PA_BW_MODE_ENT[] = {
    ENUM_ENTRY(CPSS_PORT_PA_BW_MODE_REGULAR_E),
    ENUM_ENTRY(CPSS_PORT_PA_BW_EXT_MODE_1_E),
    ENUM_ENTRY(CPSS_PORT_PA_BW_EXT_MODE_2_E),
    ENUM_ENTRY(CPSS_PORT_PA_BW_EXT_MODE_3_E),
    ENUM_ENTRY(CPSS_PORT_PA_BW_EXT_MODE_4_E),
    ENUM_ENTRY(CPSS_PORT_PA_BW_EXT_MODE_5_E),
    ENUM_ENTRY(CPSS_PORT_PA_BW_EXT_MODE_6_E),
    ENUM_ENTRY(CPSS_PORT_PA_BW_EXT_MODE_7_E),
    ENUM_ENTRY(CPSS_PORT_PA_BW_EXT_MODE_8_E),
    ENUM_ENTRY(CPSS_PORT_PA_BW_MODE_LAST_E),
    { 0, NULL }
};

...
)
{
    ...
    case CPSS_DXCH_TTI_ACTION_TYPE2_ENT:
        ...
        actionPtr->type2.tunnelHeaderStartL4Enable       = (GT_BOOL)inFields[96];
        actionPtr->type2.skipFdbSaLookupEnable           = (GT_BOOL)inFields[97];
        actionPtr->type2.ipv6SegmentRoutingEndNodeEnable = (GT_BOOL)inFields[98];
        actionPtr->type2.exactMatchOverTtiEn             = (GT_BOOL)inFields[99];
        break;
...
)
{
    ...
    case CPSS_DXCH_TTI_ACTION_TYPE2_ENT:
        ...
        inFields[96] = actionPtr->type2.tunnelHeaderStartL4Enable;
        inFields[97] = actionPtr->type2.skipFdbSaLookupEnable;
        inFields[98] = actionPtr->type2.ipv6SegmentRoutingEndNodeEnable;
        inFields[99] = actionPtr->type2.exactMatchOverTtiEn;
...
/**
* @internal wrCpssDxChTtiGreExtensionsEnableSet function
* @endinternal
*
...
/**
* @internal wrCpssDxChTtiGreExtensionsEnableGet function
* @endinternal
*
...
/**
* @internal wrCpssDxChTtiPortTrillEnableSet function
* @endinternal
*
...
*
*/
static CMD_STATUS wrCpssDxChTtiPortTrillEnableSet
(
    IN  GT_UINTPTR inArgs[CMD_MAX_ARGS],
    IN  GT_UINTPTR inFields[CMD_MAX_FIELDS],
    IN  GT_32 numFields,
...
)
{
    ...
    /* call cpss api function */
    result = cpssDxChTtiPortTrillEnableSet(devNum,portNum,enable);
...
/**
* @internal wrCpssDxChTtiPortTrillEnableGet function
* @endinternal
*
...
*
*/
static CMD_STATUS wrCpssDxChTtiPortTrillEnableGet
(
    IN  GT_UINTPTR inArgs[CMD_MAX_ARGS],
    IN  GT_UINTPTR inFields[CMD_MAX_FIELDS],
    IN  GT_32 numFields,
...
)
{
    ...
    /* call cpss api function */
    result = cpssDxChTtiPortTrillEnableGet(devNum, portNum, &enable);
...
/**
* @internal wrCpssDxChTtiTrillAdjacencyCheckEntrySet function
* @endinternal
*
...
* @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device
*/
static CMD_STATUS wrCpssDxChTtiTrillAdjacencyCheckEntrySet
(
    IN  GT_UINTPTR inArgs[CMD_MAX_ARGS],
    IN  GT_UINTPTR inFields[CMD_MAX_FIELDS],
    IN  GT_32 numFields,
...
)
{
    ...
    cpssOsMemSet(&value, 0, sizeof(CPSS_DXCH_TTI_TRILL_ADJACENCY_STC));
    galtisMacAddr(&value.outerMacSa, (GT_U8*)inArgs[2]);
    value.trillMBit = (GT_U32)inArgs[3];
    value.trillEgressRbid = (GT_U32)inArgs[4];
    value.srcHwDevice = (GT_HW_DEV_NUM)inArgs[5];
    value.srcIsTrunk = (GT_U32)inArgs[6];
    value.srcPortTrunk = (GT_U32)inArgs[7];

    /* call cpss api function */
    result = cpssDxChTtiTrillAdjacencyCheckEntrySet(devNum,entryIndex,&value);
...
/**
* @internal wrCpssDxChTtiTrillAdjacencyCheckEntryGet function
* @endinternal
*
...
* @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device
*/
static CMD_STATUS wrCpssDxChTtiTrillAdjacencyCheckEntryGet
(
    IN  GT_UINTPTR inArgs[CMD_MAX_ARGS],
    IN  GT_UINTPTR inFields[CMD_MAX_FIELDS],
    IN  GT_32 numFields,
...
)
{
    ...
    /* call cpss api function */
    result = cpssDxChTtiTrillAdjacencyCheckEntryGet(devNum, entryIndex, &value);

    /* pack output arguments to galtis string */
    galtisOutput(outArgs, result, "%6b%d%d%d%d%d", value.outerMacSa,
                                           value.trillMBit,
                                           value.trillEgressRbid,
                                           value.srcHwDevice,
                                           value.srcIsTrunk,
                                           value.srcPortTrunk);
    return CMD_OK;
...
/**
* @internal wrCpssDxChTtiPortTrillOuterVid0Set function
* @endinternal
*
...
* @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device
*/
static CMD_STATUS wrCpssDxChTtiPortTrillOuterVid0Set
(
    IN  GT_UINTPTR inArgs[CMD_MAX_ARGS],
    IN  GT_UINTPTR inFields[CMD_MAX_FIELDS],
    IN  GT_32 numFields,
...
)
{
    ...
    /* call cpss api function */
    result = cpssDxChTtiPortTrillOuterVid0Set(devNum,portNum,vlanId);
...
/**
* @internal wrCpssDxChTtiPortTrillOuterVid0Get function
* @endinternal
*
...
* @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device
*/
static CMD_STATUS wrCpssDxChTtiPortTrillOuterVid0Get
(
    IN  GT_UINTPTR inArgs[CMD_MAX_ARGS],
    IN  GT_UINTPTR inFields[CMD_MAX_FIELDS],
    IN  GT_32 numFields,
...
)
{
    ...
    /* call cpss api function */
    result = cpssDxChTtiPortTrillOuterVid0Get(devNum, portNum, &vlanId);

    /* pack output arguments to galtis string */
    galtisOutput(outArgs, result, "%d", vlanId);

    return CMD_OK;
}

/**
* @internal wrCpssDxChTtiTrillCpuCodeBaseSet function
* @endinternal
*
...
* @retval GT_OUT_OF_RANGE          - parameter not in valid range.
*/
static CMD_STATUS wrCpssDxChTtiTrillCpuCodeBaseSet
(
    IN  GT_UINTPTR inArgs[CMD_MAX_ARGS],
    IN  GT_UINTPTR inFields[CMD_MAX_FIELDS],
    IN  GT_32 numFields,
...
)
{
    ...
    devNum = (GT_U8)inArgs[0];
    cpuCodeBase = (GT_PORT_NUM)inArgs[1];

    /* call cpss api function */
    result = cpssDxChTtiTrillCpuCodeBaseSet(devNum,cpuCodeBase);
...
/**
* @internal wrCpssDxChTtiTrillCpuCodeBaseGet function
* @endinternal
*
* @brief   This function gets the Outer Tag0 VID that must be for all TRILL packets
*         from the port.
...
* @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device
*/
static CMD_STATUS wrCpssDxChTtiTrillCpuCodeBaseGet
(
    IN  GT_UINTPTR inArgs[CMD_MAX_ARGS],
    IN  GT_UINTPTR inFields[CMD_MAX_FIELDS],
    IN  GT_32 numFields,
...
)
{
    ...
    /* call cpss api function */
    result = cpssDxChTtiTrillCpuCodeBaseGet(devNum,&cpuCodeBase);
...
/**
* @internal wrCpssDxChTtiTrillMaxVersionSet function
* @endinternal
*
...
* @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device
*/
static CMD_STATUS wrCpssDxChTtiTrillMaxVersionSet
(
    IN  GT_UINTPTR inArgs[CMD_MAX_ARGS],
    IN  GT_UINTPTR inFields[CMD_MAX_FIELDS],
    IN  GT_32 numFields,
...
)
{
    ...
    devNum = (GT_U8)inArgs[0];
    maxTrillVersion = (GT_PORT_NUM)inArgs[1];

    /* call cpss api function */
    result = cpssDxChTtiTrillMaxVersionSet(devNum,maxTrillVersion);
...
/**
* @internal wrCpssDxChTtiTrillMaxVersionGet function
* @endinternal
*
...
* @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device
*/
static CMD_STATUS wrCpssDxChTtiTrillMaxVersionGet
(
    IN  GT_UINTPTR inArgs[CMD_MAX_ARGS],
    IN  GT_UINTPTR inFields[CMD_MAX_FIELDS],
    IN  GT_32 numFields,
...
)
{
    ...
    /* call cpss api function */
    result = cpssDxChTtiTrillMaxVersionGet(devNum,&maxTrillVersion);

    /* pack output arguments to galtis string */
    galtisOutput(outArgs, result, "%d", maxTrillVersion);
...
static CMD_COMMAND dbCommands[] =
{
    ...
    {"cpssDxChTtiPortTrillEnableSet",
        &wrCpssDxChTtiPortTrillEnableSet,
        3, 0},
    {"cpssDxChTtiPortTrillEnableGet",
        &wrCpssDxChTtiPortTrillEnableGet,
        2, 0},
    {"cpssDxChTtiTrillAdjacencyCheckEntrySet",
        &wrCpssDxChTtiTrillAdjacencyCheckEntrySet,
        3, 0},
    {"cpssDxChTtiTrillAdjacencyCheckEntryGet",
        &wrCpssDxChTtiTrillAdjacencyCheckEntryGet,
        2, 0},
    {"cpssDxChTtiPortTrillOuterVid0Set",
        &wrCpssDxChTtiPortTrillOuterVid0Set,
        3, 0},
    {"cpssDxChTtiPortTrillOuterVid0Get",
        &wrCpssDxChTtiPortTrillOuterVid0Get,
        2, 0},
    {"cpssDxChTtiTrillCpuCodeBaseSet",
        &wrCpssDxChTtiTrillCpuCodeBaseSet,
        2, 0},
    {"cpssDxChTtiTrillCpuCodeBaseGet",
        &wrCpssDxChTtiTrillCpuCodeBaseGet,
        1, 0},
    {"cpssDxChTtiTrillMaxVersionSet",
        &wrCpssDxChTtiTrillMaxVersionSet,
        2, 0},
    {"cpssDxChTtiTrillMaxVersionGet",
        &wrCpssDxChTtiTrillMaxVersionGet,
        1, 0},
...
)
{
    ...
    cmdOsMemSet(ttiRuleActionType, 0, sizeof(ttiRuleActionType));
    ruleIndex = 0;
    ruleIndexMaxGet = 0;
    isMask = GT_FALSE;
}

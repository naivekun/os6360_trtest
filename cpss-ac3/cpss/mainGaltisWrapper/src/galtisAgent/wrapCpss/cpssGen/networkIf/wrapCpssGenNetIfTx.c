...
#if defined EXMXPM_FAMILY
/**
* @internal prvWrCpssExMxPmSpecificTxPktInfoClear function
* @endinternal
*
* @brief   clear specific tx pkt info(set all fields zero)
*
* @param[in] pktInfoPtr               (pointer to) pkt specific info
*
* @retval GT_OK                    - on success
...
/**
* @internal getExMxPm2NetIfTblExtFieldsEntry function
* @endinternal
*
* @brief   Retruns specific packet descriptor entry from the table.
*
...
#if defined EXMXPM_FAMILY
/**
* @internal wrCpssGenNetIfTxForwardEntrySet function
* @endinternal
*
* @brief   Creates new transmit parameters description entry in the "forward" DSA Tag table.
*
* @retval CMD_OK                   - on success.
* @retval CMD_AGENT_ERROR          - on failure.
* @retval CMD_FIELD_UNDERFLOW      - not enough field arguments.
* @retval CMD_FIELD_OVERFLOW       - too many field arguments.
*
* @note Relevant for Puma3 and above devices
*
*/
...
/**
* @internal getTxNetIfForwardTblEntry function
* @endinternal
*
* @brief   Retruns specific packet descriptor entry from the "forward" DSA Tag table.
*
* @retval CMD_OK                   - on success.
* @retval CMD_AGENT_ERROR          - on failure.
* @retval CMD_FIELD_UNDERFLOW      - not enough field arguments.
...
/**
* @internal wrCpssGenNetIfTxForwardEntryGet function
* @endinternal
*
* @brief   Retruns specific packet descriptor entry from the "forward" DSA Tag table.
*
...
/**
* @internal wrCpssGenNetIfTxForwardEntryGetFirst function
* @endinternal
*
* @brief   Get first entry in the "forward" DSA Tag table.
*
* @retval CMD_OK                   - on success.
* @retval CMD_AGENT_ERROR          - on failure.
* @retval CMD_FIELD_UNDERFLOW      - not enough field arguments.
...
/**
* @internal wrCpssGenNetIfTxForwardEntryGetNext function
* @endinternal
*
* @brief   Get next entry in the "forward" DSA Tag table.
*
* @retval CMD_OK                   - on success.
* @retval CMD_AGENT_ERROR          - on failure.
* @retval CMD_FIELD_UNDERFLOW      - not enough field arguments.

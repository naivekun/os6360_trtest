...
)
{
    ...
    {
        rc = prvTgfBrgVlanEntryWrite(prvTgfDevNum, (GT_U16)prvTgfVlanArray[vlanIter],
    ...
    {
        rc = prvTgfBrgVlanMemberAdd(prvTgfDevNum, (GT_U16)prvTgfVlanPerPortArray[portIter],
...
)
{
    ...
    /* -------------------------------------------------------------------------
     * 0. AUTODOC: Set Inlif Entry - that needs for Puma devices
     */
...
*
* @param[in] isL4Offset - tunnelHeaderStartL4Enable value in TTI action
*
*/
GT_VOID prvTgfTunnelTermTunnelHeaderStartTtiConfigurationSet
(
    IN GT_BOOL  isL4Offset
)
{
    GT_STATUS                rc = GT_OK;
    ...
    ttiAction.tunnelHeaderStartL4Enable         = isL4Offset;

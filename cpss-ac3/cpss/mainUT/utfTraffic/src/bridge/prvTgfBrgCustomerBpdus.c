...
/**
********************************************************************************
* @file prvTgfBrgCustomerBpdus.c
*
* @brief Customer BPDUs - Change Command
*
* @version   4
********************************************************************************
*/
...
{
    {0x01, 0x80, 0xc2, 0x00, 0x00, 0x02},               /* dstMac */
...
/**
* @internal prvTgfBrgCustomerBpdusConfigSet function
* @endinternal
*
* @brief   Set test configuration
*/
GT_VOID prvTgfBrgCustomerBpdusConfigSet
(
    GT_VOID
)
{
    ...
    prvTgfBrgVlanEntryStore(PRV_TGF_DEF_VLANID_CNS);
    ...
    /* AUTODOC: set MC_ADDR_2 CPU code for profile 0 and standard protocol 2 */
...
/**
* @internal prvTgfBrgCustomerBpdusTrafficGenerate function
* @endinternal
*
* @brief   Generate traffic
*/
GT_VOID prvTgfBrgCustomerBpdusTrafficGenerate
(
    GT_VOID
)
{
    ...
    for (sendIter = 0; sendIter < PRV_TGF_SEND_PACKETS_NUM_CNS; sendIter++)
    {
        ...
        /* AUTODOC:   DA=01:80:C2:00:00:02, SA=00:00:00:00:00:02, VID=2 */
        ...
        vfdArray[1].offset = TGF_L2_HEADER_SIZE_CNS + TGF_VLAN_TAG_SIZE_CNS - 1;
        vfdArray[1].cycleCount = 1;
        vfdArray[1].patternPtr[0] = PRV_TGF_VLANID_2_CNS;
...
/**
* @internal prvTgfBrgCustomerBpdusConfigRestore function
* @endinternal
*
* @brief   Restore test configuration
*/
GT_VOID prvTgfBrgCustomerBpdusConfigRestore
(
    GT_VOID
)
{
    ...
    /* AUTODOC: restore command for specific IEEE reserved multicast */
    rc = prvTgfBrgSctIeeeReservedMcProtocolCmdSet(PRV_TGF_PROFILE_INDEX_CNS, 
                                                  PRV_TGF_SCT_IEEE_RSV_MC_PROTOCOL_STD_E, 
                                                  PRV_TGF_PROTOCOL_NUM_CNS,  
                                                  CPSS_PACKET_CMD_FORWARD_E);
    ...
    prvTgfBrgVlanEntryRestore(PRV_TGF_DEF_VLANID_CNS);

...
/**
********************************************************************************
* @file prvTgfFdbPerInlifPortUnregIpv6McFiltering.c
*
...
static TGF_MAC_ADDR prvTgfFdbEntryMacAddr = {0x33, 0x33, 0x00, 0x00, 0x00, 0x02};

/* default unknown macAddr */
static TGF_MAC_ADDR prvTgfUnknownMacAddr = {0x33, 0x33, 0x00, 0x00, 0x00, 0x01};
...
{
    {0x33, 0x33, 0x00, 0x00, 0x00, 0x01},               /* dstMac */
...
)
{
    ...
    /* AUTODOC: add FDB entry with MAC 33:33:00:00:00:02, VLAN 2, VID 2 */
...
)
{
    ...
    for (stageNum = 0; stageNum < PRV_TGF_SEQUENCE_LEN_CNS; stageNum++ )
    {
        ...
        /* AUTODOC: set InLIF's filtering mode for unreg IP MC to: */
        ...
        /* AUTODOC: for stages 1,4,5,6 send 10 unreg IPv6 MC packets on port 0 with: */
        /* AUTODOC:   DA=33:33:00:00:00:01, SA=00:00:00:00:00:88, VID=2 */
        /* AUTODOC:   sIP=6545:0000:0000:0000:0000:0000:0000:3212 */
        /* AUTODOC:   dIP=ff02:0000:0000:0000:0000:0000:ccdd:eeff */

        /* AUTODOC: for stages 2,3 send 10 unreg\reg IPv6 MC packets on port 0 with: */
        /* AUTODOC:   DAs=[33:33:00:00:00:01,33:33:00:00:00:02] */
        ...
        /* AUTODOC:   1 stage - 10 IPv6 packets received on ports 1,2,3 */
        /* AUTODOC:   2 stage - 10 IPv6 packets dropped */
        /* AUTODOC:   3 stage - 10 IPv6 packets received on ports 1,2,3 */
        /* AUTODOC:   4 stage - traffic trapped to CPU */
        /* AUTODOC:   5 stage - 10 IPv6 packets received on ports 1,2,3 */
        /* AUTODOC:   6 stage - 10 IPv6 packets received on ports 1,2,3 */

#
# Golden Mode library for Aldrin2
#
# Please note: 4th and 5th parameter of build sh changed:
#	4th parameter: chip_name (ALDRIN2)
#   5th parameter: mode { RELEASE | DEBUG | PURIFY }
#
# Example:
#   Build.sh Linux i386 LinuxWM ALDRIN2 DEBUG ALDRIN2_GM $OBJS_DIR
#

export GM_ROOT=$GM_PATH
export GM_PROJECT=Aldrin2Gm

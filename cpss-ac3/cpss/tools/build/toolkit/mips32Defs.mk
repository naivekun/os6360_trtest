#
# Make definitions for GNU based tools (mips32)
#
...
LDFLAGS=$(_ENDIAN_FLAG) -m elf32btsmip -r -X -N
#BM_SHM_LDFLAGS_LD =$(_ENDIAN_FLAG) -m elf64btsmip -ldl -Bsymbolic-functions
BM_SHM_LDFLAGS_LD =$(_ENDIAN_FLAG) -m elf32btsmip -ldl -Bsymbolic-functions
#BM_SHM_LDFLAGS_CC=-meb -mabi=64 -msoft-float -fpic -ldl -Xlinker -Bsymbolic-functions
BM_SHM_LDFLAGS_CC=-meb -mabi=32 -msoft-float -fpic -ldl -Xlinker -Bsymbolic-functions
export LDFLAGS

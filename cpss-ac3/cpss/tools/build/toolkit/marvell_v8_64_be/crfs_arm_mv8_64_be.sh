...
usage_exit() {
	...
	echo "Usage: crfs_arm_mv8_64.sh <ROOTFS_PATH> <MV8_64_BE_PATH> <BUSYBOX_PATH>"
	echo
	echo "Examples: "
	echo
	echo
	echo " ./crfs_arm_mv8_64.sh /tftpboot/rootfs_arm-mv8_64_be \\"
	echo "       /swtools/devtools/gnueabi/arm_be/aarch64v8_be-marvell-linux-gnu \\"
...
then
  ...
  then
	...
	echo " <MV8_64_BE_PATH> - path where MV8_64_be toolchain or newer package was installed."
	echo ""
	echo "Example: "
	echo " ./crfs_arm_mv8_64.sh /tftpboot/rootfs_arm-mv8_64_be \\"
	echo "      /swtools/devtools/gnueabi/arm_be/aarch64v8_be-marvell-linux-gnu \\"
...
mv8_64_libc_root=$mv8_64/aarch64_be-linux-gnu/libc
mv8_64_lib=$mv8_64_libc_root/lib
mv8_64_lib2=$mv8_64_lib
mv8_64_prefix=$mv8_64/bin/aarch64_be-marvell-linux-gnu-
...
toolchain=marvell_v8_64_be big endian
...
cat ./motd |sed '/Welcome to Embedded Linux/ s/$/ Telnet/' >./welcome
...
lib        = \${sdk_prefix}/aarch64_be-linux-gnu/libc/lib

cmd_prefix = \${sdk_prefix}/bin/aarch64_be-marvell-linux-gnu-
...
then
 ...
 mount -t tmpfs -n -o size=64M none /dev/shm

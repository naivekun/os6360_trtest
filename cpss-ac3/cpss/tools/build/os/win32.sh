...
if [ "$FORCE_GM_LION_USE" = "EXISTS" ];then
   ...
   export DESTINATION_BSP_DIR="$COMPILATION_ROOT\\application\\work\\${TOOLKIT}_gm_aldrin2"
elif [ "$FORCE_GM_FALCON_USE" = "EXISTS" ];then
   export DESTINATION_BSP_DIR="$COMPILATION_ROOT\\application\\work\\${TOOLKIT}_gm_falcon"

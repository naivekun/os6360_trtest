...
/* in Falcon 12.8T there are 256+2 MACs */
#define PRV_CPSS_MAX_MAC_PORTS_NUM_CNS          (256+2)
...
#define                         PRV_CPSS_MAX_FUNCTIONALITY_RESOLUTION_CNS 2


extern CPSS_OS_MUTEX   prvCpssApiLockDevicelessMtx[PRV_CPSS_MAX_FUNCTIONALITY_RESOLUTION_CNS ];
extern CPSS_OS_MUTEX   prvCpssApiLockByDevNumAndFunctionalityMtx[PRV_CPSS_MAX_PP_DEVICES_CNS][PRV_CPSS_MAX_FUNCTIONALITY_RESOLUTION_CNS ] ;
...
#define CPSS_ZERO_LEVEL_API_LOCK_MAC\
    do\
    {\
        cpssOsMutexLock(prvCpssApiLockDevicelessMtxZeroLevel);\
    }\
    while(0);
...
#define CPSS_ZERO_LEVEL_API_UNLOCK_MAC\
    do\
    {\
        cpssOsMutexUnlock(prvCpssApiLockDevicelessMtxZeroLevel);\
    }\
    while(0);
...
#define CPSS_API_LOCK_MAC(_devNum,_functionality)\
    ...
    {\
        cpssOsMutexLock(prvCpssApiLockByDevNumAndFunctionalityMtx[_devNum][_functionality]);\
    }


#define CPSS_API_LOCK_DEVICELESS_MAC(_functionality)\
    {\
        cpssOsMutexLock(prvCpssApiLockDevicelessMtx[_functionality]);\
    }
...
#define CPSS_API_UNLOCK_MAC(_devNum,_functionality)\
    if (_devNum < PRV_CPSS_MAX_PP_DEVICES_CNS)\
    {\
        cpssOsMutexUnlock(prvCpssApiLockByDevNumAndFunctionalityMtx[_devNum][_functionality]);\
    }

#define CPSS_API_UNLOCK_DEVICELESS_MAC(_functionality)\
    {\
        cpssOsMutexUnlock(prvCpssApiLockDevicelessMtx[_functionality]);\
    }

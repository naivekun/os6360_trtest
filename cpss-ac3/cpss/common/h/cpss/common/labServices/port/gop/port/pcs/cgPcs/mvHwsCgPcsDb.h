...
typedef enum
{
    ...
    CGPCS_MODE_2_LANE_0_SEQ,
    CGPCS_MODE_2_LANE_2_SEQ,
    CGPCS_MODE_4_LANE_SEQ,
    CGPCS_RS_FEC_2_LANE_0_SEQ,
    CGPCS_RS_FEC_2_LANE_2_SEQ,
    CGPCS_RS_FEC_4_LANE_SEQ,
    CGPCS_RESET_1_LANE_0_SEQ,
    CGPCS_RESET_1_LANE_1_SEQ,
    CGPCS_RESET_1_LANE_2_SEQ,
    CGPCS_RESET_1_LANE_3_SEQ,
    CGPCS_RESET_2_LANE_0_SEQ,
    CGPCS_RESET_2_LANE_2_SEQ,
    ...
    CGPCS_UNRESET_2_LANE_0_SEQ,
    CGPCS_UNRESET_2_LANE_2_SEQ,
    ...
    CGPCS_POWER_DOWN_2_LANE_0_SEQ,
    CGPCS_POWER_DOWN_2_LANE_2_SEQ,
    ...
    CGPCS_REDUCED_POWER_DOWN_2_LANE_0_SEQ,
    CGPCS_REDUCED_POWER_DOWN_2_LANE_2_SEQ,
...
extern MV_CFG_SEQ *hwsCgPcsPscSeqDb;

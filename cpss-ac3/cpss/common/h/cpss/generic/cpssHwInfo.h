...
#define CPSS_HW_INFO_IRQ_NOT_USED_CNS   0  /* Interrupt not used/configured */
 ...
 *                                    routine with IRQ
 *                                    The value CPSS_HW_INFO_IRQ_NOT_USED_CNS
...
{                                                                       \
    ...
    {                                                                   \
        CPSS_HW_INFO_IRQ_NOT_USED_CNS, /* irq.switching              */ \
        CPSS_HW_INFO_IRQ_NOT_USED_CNS  /* irq.doorbell               */ \
    },                                                                  \
    {                                                                   \
        CPSS_HW_INFO_IRQ_NOT_USED_CNS  /* intMask.switching          */ \
    },                                                                  \
    {                                                                   \
        { 0, 0, 0 },              /* resource.cnm                    */ \
        { 0, 0, 0 },              /* resource.switching              */ \
        { 0, 0, 0 },              /* resource.resetAndInitController */ \
        { 0, 0, 0 },              /* resource.sram                   */ \
        { 0, 0, 0 },              /* resource.mg1                    */ \
        { 0, 0, 0 },              /* resource.mg2                    */ \
        { 0, 0, 0 },              /* resource.mg3                    */ \
        {                                                               \
            { 0, 0, 0 },          /* resource.dragonite.itcm         */ \
            { 0, 0, 0 }           /* resource.dragonite.dtcm         */ \
        }                                                               \
    },                                                                  \
    NULL                          /* driver                          */ \
}

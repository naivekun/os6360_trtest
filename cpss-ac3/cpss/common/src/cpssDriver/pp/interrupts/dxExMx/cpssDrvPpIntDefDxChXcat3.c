...
*/
static GT_U32 xcat3UniEvMapTableWithExtData[] = {
 /* Per Queue events */
...
static GT_U32 xcat3UniEvMapTableWithExtDataSize = (sizeof(xcat3UniEvMapTableWithExtData)/(sizeof(GT_U32)));


/* Interrupt cause to unified event map for xCat3
 This Table is for unified event without extended data
*/
static GT_U32 xcat3UniEvMapTable[][2] =
{
...
static GT_U32 xcat3UniEvMapTableSize = (sizeof(xcat3UniEvMapTable)/(sizeof(GT_U32)*2));

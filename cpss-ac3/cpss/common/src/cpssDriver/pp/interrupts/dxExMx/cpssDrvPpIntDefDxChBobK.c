...
*/
static GT_U32 bobkUniEvMapTableWithExtData[] = {
 /* Per Queue events */
...
static GT_U32 bobkCetusUniEvMapTableWithExtData[] = {
 /* Per Queue events */
 CPSS_PP_TX_BUFFER_QUEUE_E,
    PRV_CPSS_BOBK_TX_SDMA_TX_BUFFER_QUEUE_0_E,  0,
    PRV_CPSS_BOBK_TX_SDMA_TX_BUFFER_QUEUE_1_E,  1,
...
*/
static GT_U32 bobkUniEvMapTable[][2] =
{
...
static GT_U32 bobkUniEvMapTableSize = (sizeof(bobkUniEvMapTable)/(sizeof(GT_U32)*2));

...
*/
static GT_U32 lion2UniEvMapTableWithExtData[] = {
...
static GT_U32 lion2UniEvMapTableWithExtDataSize = (sizeof(lion2UniEvMapTableWithExtData)/(sizeof(GT_U32)));
...
* @endinternal
*
* @brief   Interrupts initialization for the Lion 2 devices.
*/

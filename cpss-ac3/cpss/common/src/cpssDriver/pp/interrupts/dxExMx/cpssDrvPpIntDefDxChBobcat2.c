...
*/
static GT_U32 bobcat2UniEvMapTableWithExtData[] = {
 /* Per Queue events */
...
static GT_U32 bobcat2UniEvMapTableWithExtDataSize = (sizeof(bobcat2UniEvMapTableWithExtData)/(sizeof(GT_U32)));


/* Interrupt cause to unified event map for Bobcat2
 This Table is for unified event without extended data
*/
static GT_U32 bobcat2UniEvMapTable[][2] =
{
...
static GT_U32 bobcat2UniEvMapTableSize = (sizeof(bobcat2UniEvMapTable)/(sizeof(GT_U32)*2));

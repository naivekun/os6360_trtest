...
PRV_CPSS_ENUM_STRING_VALUE_PAIR_STC prvCpssLogEnum_map_CPSS_DRV_HW_RESOURCE_TYPE_ENT[]  =
...
PRV_CPSS_LOG_FUNC_PARAM_STC IN_CPSS_DRV_HW_RESOURCE_TYPE_ENT_resourceType = {
...
PRV_CPSS_LOG_FUNC_PARAM_STC IN_GT_U32_mgNum = {
...
PRV_CPSS_LOG_FUNC_PARAM_STC OUT_GT_U32_HEX_PTR_data = {
     "data", PRV_CPSS_LOG_PARAM_OUT_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(GT_U32_HEX)
};
PRV_CPSS_LOG_FUNC_PARAM_STC OUT_GT_U32_HEX_PTR_dataArr = {
     "dataArr", PRV_CPSS_LOG_PARAM_OUT_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(GT_U32_HEX)
};
PRV_CPSS_LOG_FUNC_PARAM_STC OUT_GT_U32_HEX_PTR_fieldData = {
...
PRV_CPSS_LOG_FUNC_PARAM_STC * prvCpssDrvHwPpMgSetRegField_PARAMS[] =  {
    &IN_GT_U8_devNum,
    &IN_GT_U32_mgNum,
...
PRV_CPSS_LOG_FUNC_PARAM_STC * prvCpssDrvHwPpMgGetRegField_PARAMS[] =  {
    &IN_GT_U8_devNum,
    &IN_GT_U32_mgNum,
    &IN_GT_U32_HEX_regAddr,
    &IN_GT_U32_fieldOffset,
...
PRV_CPSS_LOG_FUNC_PARAM_STC * prvCpssDrvHwPpMgWriteReg_PARAMS[] =  {
    &IN_GT_U8_devNum,
    &IN_GT_U32_mgNum,
    &IN_GT_U32_HEX_regAddr,
    &IN_GT_U32_HEX_data
};
PRV_CPSS_LOG_FUNC_PARAM_STC * prvCpssDrvHwPpMgReadReg_PARAMS[] =  {
    &IN_GT_U8_devNum,
    &IN_GT_U32_mgNum,
    &IN_GT_U32_HEX_regAddr,
    &OUT_GT_U32_HEX_PTR_data
};
PRV_CPSS_LOG_FUNC_PARAM_STC * cpssDrvPpHwResourceWriteRegister_PARAMS[] =  {
    &IN_GT_U8_devNum,
...
PRV_CPSS_LOG_FUNC_PARAM_STC * cpssDrvPpHwResourceReadRegister_PARAMS[] =  {
    &IN_GT_U8_devNum,
    &IN_GT_U32_portGroupId,
    &IN_CPSS_DRV_HW_RESOURCE_TYPE_ENT_resourceType,
    &IN_GT_U32_HEX_regAddr,
...
PRV_CPSS_LOG_FUNC_PARAM_STC * cpssDrvPpHwRamInReverseWrite_PARAMS[] =  {
    &IN_GT_U8_devNum,
    &IN_GT_U32_portGroupId,
    &IN_GT_U32_HEX_addr,
    &IN_GT_U32_length,
...
PRV_CPSS_LOG_FUNC_PARAM_STC * prvCpssDrvHwPpPortGroupReadRam_PARAMS[] =  {
    &IN_GT_U8_devNum,
    &IN_GT_U32_portGroupId,
    &IN_GT_U32_HEX_addr,
    &IN_GT_U32_length,
...
PRV_CPSS_LOG_FUNC_PARAM_STC * prvCpssDrvHwPpPortGroupWriteVec_PARAMS[] =  {
    &IN_GT_U8_devNum,
    &IN_GT_U32_portGroupId,
...
PRV_CPSS_LOG_FUNC_PARAM_STC * prvCpssDrvHwPpPortGroupReadVec_PARAMS[] =  {
    &IN_GT_U8_devNum,
    &IN_GT_U32_portGroupId,
    &IN_GT_U32_HEX_PTR_addrArr,
...
PRV_CPSS_LOG_FUNC_PARAM_STC * prvCpssDrvHwPpWriteRamInReverse_PARAMS[] =  {
    &IN_GT_U8_devNum,
    &IN_GT_U32_HEX_addr,
    &IN_GT_U32_length,
    &IN_GT_U32_HEX_PTR_data
...
extern PRV_CPSS_LOG_FUNC_PARAM_STC * cpssDrvPpHwRamRead_PARAMS[];
extern PRV_CPSS_LOG_FUNC_PARAM_STC * cpssDrvPpHwRamWrite_PARAMS[];
extern PRV_CPSS_LOG_FUNC_PARAM_STC * cpssDrvPpHwVectorRead_PARAMS[];
extern PRV_CPSS_LOG_FUNC_PARAM_STC * cpssDrvPpHwVectorWrite_PARAMS[];
extern PRV_CPSS_LOG_FUNC_PARAM_STC * prvCpssDrvHwPpReadRam_PARAMS[];
extern PRV_CPSS_LOG_FUNC_PARAM_STC * prvCpssDrvHwPpReadVec_PARAMS[];
extern PRV_CPSS_LOG_FUNC_PARAM_STC * prvCpssDrvHwPpWriteRam_PARAMS[];
extern PRV_CPSS_LOG_FUNC_PARAM_STC * prvCpssDrvHwPpWriteVec_PARAMS[];
...
static PRV_CPSS_LOG_FUNC_ENTRY_STC prvCpssCommonDXCpssDriverLogLibDb[] = {
...
static PRV_CPSS_LOG_FUNC_ENTRY_STC prvCpssCommonPXCpssDriverLogLibDb[] = {
    {"cpssDrvInterruptsTreeGet", 5, cpssDrvInterruptsTreeGet_PARAMS, NULL},

...
DECLARE_FUNC(cpssExtDrvIntDisconnect, CPSS_EXTDRV_INT_DISCONNECT_FUNC);
...
DECLARE_FUNC(cpssOsMutexSetGlAttributes, CPSS_OS_MUTEX_SET_GL_ATTRIBUTES_FUNC);
DECLARE_FUNC(cpssOsCheckUnprotectedPerDeviceDbAccess, CPSS_OS_CHECK_UNPROTECTED_PER_DEVICE_DB_ACCESS);
#endif
...
DECLARE_FUNC0(cpssOsStrTol, CPSS_OS_STR_TOL_FUNC);
...
)
{
    ...
    REPLACE_IF_NOT_NULL_MAC(cpssExtDrvIntDisconnect       ,prvCpssBindFuncs.extDrv.extDrvIntBindInfo.extDrvIntDisconnectFunc);
    ...
    MANDATORY_FUNCTION(cpssOsBzero              , prvCpssBindFuncs.os.osMemBindInfo.osMemBzeroFunc);
    MANDATORY_FUNCTION(cpssOsMemSet             , prvCpssBindFuncs.os.osMemBindInfo.osMemSetFunc);
    MANDATORY_FUNCTION(cpssOsMemCpy             , prvCpssBindFuncs.os.osMemBindInfo.osMemCpyFunc);
    REPLACE_IF_NOT_NULL_MAC(cpssOsMemMove       , prvCpssBindFuncs.os.osMemBindInfo.osMemMoveFunc);
    MANDATORY_FUNCTION(cpssOsMemCmp             , prvCpssBindFuncs.os.osMemBindInfo.osMemCmpFunc);
    REPLACE_IF_NOT_NULL_MAC(cpssOsStaticMalloc  , prvCpssBindFuncs.os.osMemBindInfo.osMemStaticMallocFunc);

#ifdef OS_MALLOC_MEMORY_LEAKAGE_DBG
    MANDATORY_FUNCTION(cpssOsMalloc_MemoryLeakageDbg        , prvCpssBindFuncs.os.osMemBindInfo.osMemMallocFunc);
    MANDATORY_FUNCTION(cpssOsRealloc_MemoryLeakageDbg       , prvCpssBindFuncs.os.osMemBindInfo.osMemReallocFunc);
    MANDATORY_FUNCTION(cpssOsFree_MemoryLeakageDbg          , prvCpssBindFuncs.os.osMemBindInfo.osMemFreeFunc);
#else  /*!OS_MALLOC_MEMORY_LEAKAGE_DBG*/
    MANDATORY_FUNCTION(cpssOsMalloc             , prvCpssBindFuncs.os.osMemBindInfo.osMemMallocFunc);
    MANDATORY_FUNCTION(cpssOsRealloc            , prvCpssBindFuncs.os.osMemBindInfo.osMemReallocFunc);
    MANDATORY_FUNCTION(cpssOsFree               , prvCpssBindFuncs.os.osMemBindInfo.osMemFreeFunc);
#endif /*!OS_MALLOC_MEMORY_LEAKAGE_DBG*/
    ...
    MANDATORY_FUNCTION(cpssOsRand               , prvCpssBindFuncs.os.osRandBindInfo.osRandFunc);
 ...
 #if defined  CPSS_USE_MUTEX_PROFILER      
    REPLACE_IF_NOT_NULL_MAC(cpssOsMutexSetGlAttributes, prvCpssBindFuncs.os.osSemBindInfo.osMutexSetGlAttributesFunc);
    REPLACE_IF_NOT_NULL_MAC(cpssOsCheckUnprotectedPerDeviceDbAccess, prvCpssBindFuncs.os.osSemBindInfo.osCheckUnprotectedPerDeviceDbAccess);
  #endif  
    ...
    REPLACE_IF_NOT_NULL_MAC(cpssOsStrTol   , prvCpssBindFuncs.os.osStrBindInfo.osStrTolFunc);

    MANDATORY_FUNCTION(cpssOsTimerWkAfter     , prvCpssBindFuncs.os.osTimeBindInfo.osTimeWkAfterFunc);

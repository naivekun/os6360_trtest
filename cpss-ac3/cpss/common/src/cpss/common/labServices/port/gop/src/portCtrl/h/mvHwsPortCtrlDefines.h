...
/* ================== */
...
#ifdef MICRO_INIT
 #if defined(ALDRIN_DEV_SUPPORT) || defined(PIPE_DEV_SUPPORT) || defined(BC3_DEV_SUPPORT)
  #define LOAD_ADDR       0
 ...
 #define HWS_IPC_LINK_ID (IPC_CM3_FREERTOS_LINK_ID)
  ...
  #define SHMEM_REGS      (SHMEM_BASE + SHMEM_SIZE - 4)
  #define HWS_IPC_LINK_ID (IPC_CM3_FREERTOS_LINK_ID)
  /* type=1==CM3_BOBK, SRAM_BASE=0==0, SRAM_SIZE=0==128K */
 #elif defined(ALDRIN_DEV_SUPPORT) || defined(BC3_DEV_SUPPORT) || defined(PIPE_DEV_SUPPORT) || defined(ALDRIN2_DEV_SUPPORT)
...
#define MV_AP_STACK                (512) /* words - 2K bytes */

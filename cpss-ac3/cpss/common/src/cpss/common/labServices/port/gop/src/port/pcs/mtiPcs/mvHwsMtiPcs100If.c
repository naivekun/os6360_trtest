...
)
{
    ...
    CHECK_STATUS(genUnitRegisterGet(devNum, portGroup, RAVEN_UNIT_MTI_PCS100, curPortParams.portPcsNumber, MTI_PCS_CONTROL1, &data, (0x1 << 14)));
...
GT_STATUS mvHwsMtiPcs100IfInit(MV_HWS_PCS_FUNC_PTRS *funcPtrArray)
{
    ...
    funcPtrArray[MTI_PCS_100].pcsFecCfgFunc    = NULL;
    funcPtrArray[MTI_PCS_100].pcsFecCfgGetFunc = mvHwsMtiPcs100FecConfigGet;
    funcPtrArray[MTI_PCS_100].pcsCheckGearBoxFunc = NULL;
    funcPtrArray[MTI_PCS_100].pcsAlignLockGetFunc = mvHwsMtiPcs100AlignLockGet;
    funcPtrArray[MTI_PCS_100].pcsActiveStatusGetFunc = NULL;

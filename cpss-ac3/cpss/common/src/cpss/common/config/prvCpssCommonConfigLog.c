...
PRV_CPSS_LOG_FUNC_PARAM_STC * cpssPpCfgNextDevGet_PARAMS[] =  {
    &IN_GT_U8_devNum,
...
#ifdef CHX_FAMILY
static PRV_CPSS_LOG_FUNC_ENTRY_STC prvCpssCommonDXConfig_commonLogLibDb[] = {
...
#ifdef PX_FAMILY
static PRV_CPSS_LOG_FUNC_ENTRY_STC prvCpssCommonPXConfig_commonLogLibDb[] = {
    {"cpssPpCfgNextDevGet", 2, cpssPpCfgNextDevGet_PARAMS, NULL},
};

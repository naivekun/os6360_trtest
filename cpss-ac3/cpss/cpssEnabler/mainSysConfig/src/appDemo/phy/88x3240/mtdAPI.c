...
#define MTD_7_0020_SPEED_BIT_LENGTH2 3   /* for 88X33X0 family Z2 revision */
#define MTD_7_0020_SPEED_BIT_POS2    10
...
)
{
    ...
    *speed_bits = (lower_speeds | (gig_speeds <<= MTD_GIG_SPEED_POS));
    ...
    {
        /* read all 3 speed bits from 7.0020 */
        ...
        /* need to unpack speed bits 7.0020.12:10>>10 on 88X33X0 Z2 */
        *speed_bits |= ((hgig_speeds & (1<<2)) ? (1<<MTD_XGIG_SPEED_POS) : 0);

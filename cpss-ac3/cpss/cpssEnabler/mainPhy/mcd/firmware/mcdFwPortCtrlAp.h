...
#ifndef __mcdFwPortCtrlAp_H
#define __mcdFwPortCtrlAp_H
...
#define AP_REG_CFG_0_LOCK_40G_CR4_MASK                        (0x0400)
...
/*rrr #define AP_REG_ST_1_AP_PWT_UP_100G_C10_MASK                   (0x0002)*/
...
#define MV_PORT_CTRL_MAX_AP_PORT_NUM  (8)
...
#define MV_PORT_CTRL_BV_MAX_AP_PORT_NUM  (8)
#define MV_PORT_CTRL_BV_AP_PORT_NUM_BASE (0)

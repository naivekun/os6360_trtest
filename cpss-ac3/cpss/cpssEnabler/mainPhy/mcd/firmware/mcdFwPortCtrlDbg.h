...
#ifndef __mcdFwPortCtrlDbg_H
#define __mcdFwPortCtrlDbg_H
...
*
*/
void mvPortCtrlDbgIntropCfg(MCD_IPC_PORT_AP_INTROP_STRUCT *apIntrop);

#ifdef __cplusplus
}
#endif /* __cplusplus */

#endif /* __mcdFwPortCtrlDbg_H */

...
*/
        ...
        case MCD_MODE_G21L:
            ...
            for ( serdesNum = 0; serdesNum < 4; serdesNum++)
            {
                ATTEMPT(mcdSerdesPowerCtrl(pDev, MCD_SERDES_NUM(serdesNum,slice), MCD_TRUE, MCD_10_3125G, MCD_FALSE, (MCD_U32)lsRefClockSel, (MCD_U32)lsRefClockSel));
                ATTEMPT(mcdSerdesTxEnable(pDev, MCD_SERDES_NUM(serdesNum,slice), MCD_TRUE));
            }
            /* configure Asic side*/
        ...
        case MCD_MODE_G21SK:
            ...
            {
                MCD_DBG_ERROR("mcdSetModeImplement: autoNegAdvEnable %u\n", autoNegAdvEnable);
                return MCD_FAIL;
            }
        ...
        case MCD_MODE_P25S:
            ...
            if (autoNegAdvEnable)
            {
                ...
                ATTEMPT(mcdSerdesPowerCtrl(pDev, MCD_SERDES_NUM((MCD_HOST_SIDE_START_SERDES_NUMBER + chan), slice), MCD_TRUE, MCD_25_78125G, noPpmEnable, (MCD_U32)hsRefClockSel, (MCD_U32)hsRefClockDiv));
...
*/
            ...
            else
            {
                ...
                {
                    ATTEMPT(mcdSerdesRxPowerCtrl(pDev, MCD_SERDES_NUM((MCD_HOST_SIDE_START_SERDES_NUMBER + chan), slice), MCD_TRUE, MCD_25_78125G, noPpmEnable,(MCD_U32)hsRefClockSel,(MCD_U32)hsRefClockDiv));
                    ATTEMPT(mcdSerdesTxPowerCtrl(pDev, MCD_SERDES_NUM((MCD_HOST_SIDE_START_SERDES_NUMBER + chan), slice), MCD_TRUE, MCD_25_78125G, noPpmEnable,(MCD_U32)hsRefClockSel,(MCD_U32)hsRefClockDiv));
                }
                else
                {
                    ATTEMPT(mcdSerdesPowerCtrl(pDev, MCD_SERDES_NUM((MCD_HOST_SIDE_START_SERDES_NUMBER + chan), slice), MCD_TRUE, MCD_25_78125G, noPpmEnable, (MCD_U32)hsRefClockSel, (MCD_U32)hsRefClockDiv));
                ...
                ATTEMPT(mcdSerdesPowerCtrl(pDev, MCD_SERDES_NUM(chan, slice), MCD_TRUE, MCD_25_78125G, MCD_FALSE, (MCD_U32)lsRefClockSel, (MCD_U32)lsRefClockDiv));

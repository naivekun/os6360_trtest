...
/*  TI IPC      */
/************* **/
#define EXTHWG_POE_DRG_Ipc_TX_HEADER_SIZE   (sizeof(GT_32)*2)
#define EXTHWG_POE_DRG_Ipc_RX_HEADER_SIZE   (sizeof(GT_32)*3)
#define EXTHWG_POE_DRG_Ipc_MAX_MSG_SIZE     256
#define EXTHWG_POE_DRG_Ipc_MAX_INTERNAL_TX_DATA_MSG_SIZE    (EXTHWG_POE_DRG_Ipc_MAX_MSG_SIZE - EXTHWG_POE_DRG_Ipc_TX_HEADER_SIZE)
#define EXTHWG_POE_DRG_Ipc_MAX_INTERNAL_RX_DATA_MSG_SIZE    (EXTHWG_POE_DRG_Ipc_MAX_MSG_SIZE - EXTHWG_POE_DRG_Ipc_RX_HEADER_SIZE)

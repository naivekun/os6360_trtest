...
function fecToVal(fec)
      if fec ==  "CPSS_PORT_FEC_MODE_ENABLED_E" then
          return 0
      elseif fec ==  "CPSS_PORT_FEC_MODE_DISABLED_E" or fec == nil then
          return 1
      elseif fec ==  "CPSS_PORT_RS_FEC_MODE_ENABLED_E" then
          return 2
      elseif fec ==  "CPSS_PORT_BOTH_FEC_MODE_ENABLED_E" then
          return 3
      else
...
function fcToVal(fec)
      if fec ==  "CPSS_PORT_AP_FLOW_CONTROL_SYMMETRIC_E" then
          return 0
      elseif fec ==  "CPSS_PORT_AP_FLOW_CONTROL_ASYMMETRIC_E" or fec == nil then
          return 1
      else
...
local function port_manager_event_set_func(params)
  ...
  for iterator, devNum, portNum in command_data:getInterfacePortIterator() do
    ...
    command_data:clearLocalStatus()
    if(nil~=devNum) then
      ret = myGenWrapper("cpssPxPortManagerEventSet",{
      {"IN","GT_U8","devNum",devNum},
      {"IN","GT_PHYSICAL_PORT_NUM","portNum",portNum},
...
local function statusShowFunc(params)
  ...
  for iterator, devNum, portNum in command_data:getInterfacePortIterator() do
    ...
    command_data:clearLocalStatus()
    if(nil~=devNum) then
      ret, localStatusPtr = myGenWrapper("cpssPxPortManagerStatusGet",{
      {"IN","GT_U8","devNum",devNum},
      {"IN","GT_PHYSICAL_PORT_NUM","portNum",portNum},
...
CLI_addCommand("interface", "port-manager parameters-set regular-port", {
  ...
  {   type="named", { format="ifMode %port_interface_mode", name="ifMode"},
            ...
            { format="fec_ability %ap_port_fec_mode_gen", name="fec_ability"},
...
--            { format="fc_asm_dir %ap_flow_control_gen", name="fcAsmDir"},
--            { format="fecSupported %ap_port_fec_mode_gen", name="fecSupported"},
--            { format="fecRequired %ap_port_fec_mode_gen", name="fecRequired"},
--            { format="lane_num %GT_U32", name="laneNum"},
--
--            { format="mode1 %ap_port_interface_mode", name="mode1"},
--            { format="speed1 %ap_port_speed", name="speed1"},
--
--            { format="fec_ability1 %ap_port_fec_mode_gen", name="fec_ability1"},
--            { format="fec_requested1 %ap_port_fec_mode_gen", name="fec_requested1"},
--
...
--            { format="fec_ability2 %ap_port_fec_mode_gen", name="fec_ability2"},
--            { format="fec_requested2 %ap_port_fec_mode_gen", name="fec_requested2"},
--
...
--            { format="fec_ability3 %ap_port_fec_mode_gen", name="fec_ability3"},
--            { format="fec_requested3 %ap_port_fec_mode_gen", name="fec_requested3"},
--
...
--            { format="fec_ability4 %ap_port_fec_mode_gen", name="fec_ability4"},
--            { format="fec_requested4 %ap_port_fec_mode_gen", name="fec_requested4"},
--
...
--            { format="fec_ability5 %ap_port_fec_mode_gen", name="fec_ability5"},
--            { format="fec_requested5 %ap_port_fec_mode_gen", name="fec_requested5"},
--
...
--            { format="fec_ability6 %ap_port_fec_mode_gen", name="fec_ability6"},
--            { format="fec_requested6 %ap_port_fec_mode_gen", name="fec_requested6"},
--
...
--            { format="fec_ability7 %ap_port_fec_mode_gen", name="fec_ability7"},
--            { format="fec_requested7 %ap_port_fec_mode_gen", name="fec_requested7"},
--
...
--            { format="fec_ability8 %ap_port_fec_mode_gen", name="fec_ability8"},
--            { format="fec_requested8 %ap_port_fec_mode_gen", name="fec_requested8"},
--
...
--            { format="fec_ability9 %ap_port_fec_mode_gen", name="fec_ability9"},
--            { format="fec_requested9 %ap_port_fec_mode_gen", name="fec_requested9"},
--
...
--          --  { format="polarity_rx_packed7 %GT_U32", name="polarity_rx_packed7"},
--          --  { format="polarity_tx_packed7 %GT_U32", name="polarity_tx_packed7"},
--            { format="fec_ability10 %ap_port_fec_mode_gen", name="fec_ability10"},
--            { format="fec_requested10 %ap_port_fec_mode_gen", name="fec_requested10"},
--
--            requirements={
--            ["speed1"] = {"mode1"},
--            ["fec_ability1"] = {"speed1"},

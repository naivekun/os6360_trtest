...
install-lib: $(addprefix $(LIB_DIR)/,$(LIB_TARGETS))
	$(INSTALL_DIR) $(SDE_INSTALL)$(DESTDIR)$(libdir)
	$(INSTALL_PROGRAM) $(LIB_DIR)/$(LIB_SHLIBNAME) $(SDE_INSTALL)$(DESTDIR)$(libdir)
	$(LN) $(LIB_SHLIBNAME) $(SDE_INSTALL)$(DESTDIR)$(libdir)/$(LIB_SHSONAME)
	$(LN) $(LIB_SHSONAME) $(SDE_INSTALL)$(DESTDIR)$(libdir)/$(LIB_SHBASENAME)
ifeq ($(BUILD_STATIC_LIB),1)
	$(INSTALL_DATA) $(LIB_DIR)/$(LIB_STLIBNAME) $(SDE_INSTALL)$(DESTDIR)$(libdir)
endif

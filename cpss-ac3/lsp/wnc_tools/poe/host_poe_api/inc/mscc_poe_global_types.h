...
#define API_VERSION      0x020011  // 2.0.17
...
#define SOFTWARE_UPDATE_S19_ACK_UART_DELAY_mS  60
...
#define B_Event					0xC1 /* 193 */
 ...
 /* Section 3.1 Adding command for "Get PoE Device Error Log" */

#define B_DeviceLog				0xC3 /* 195 */
#define B_LogSectorStatus		0xC4 /* 196 */
...
typedef enum
{
	...
	eLog_Sector_Clear_Stamp,
	eSet_Class_Power,
	eGet_Class_Power,

    eGet_PoE_Device_Status,
	eGet_PoE_Device_Register,
	eGet_PoE_Device_Error_Log,
	eGet_Log_Sector_Status,
...
typedef enum
{
	...
	ePOE_STATUS_ERR_FIRMWARE_DOWNLOAD_S19_FILE_CONTENT_ERROR            = -40,
	ePOE_STATUS_MAX						                                = -41,
}PoE_Status_e;
...
typedef struct
{
    U8    bSeverity1_Log_Status  :2; /* 0 - 1 */
    U8    bSeverity2_Log_Status  :2; /* 2 - 3 */
    U8    bSeverity3_Log_Status  :2; /* 4 - 5 */
    U8    bReserved				 :2;
}VOP_Severity_Errors_t;
...
typedef struct
{
	...
	POE_BOOL_e  Bit3_LLDP_Message_Type	         : 1;
}Execute_LLDP_t;
    ...
    union
    {
	   ...
	   Get_PoE_Device_Register_t;
   	   ...
   	   struct
   	   {
   		   ...
   		   struct
	   	   {
	   		   VOP_Severity_Errors_t tVOPseverityErrors;
	   		   U8 bStruct_Error;
	   	   }Get;
	   	}
	   	Get_PoE_Device_Error_Log_t;
	   	...
	   	struct
	   	{
	   	   ...
	   	   {
	   		   U8 bSector_Error;
	   		   U16 wErase_Sector_Counter;
	   	   }Get;
	   	}
	   	Get_Log_Sector_Status_t;
